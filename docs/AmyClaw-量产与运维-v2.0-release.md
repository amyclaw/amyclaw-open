...
| **版本号** | 环境变量 **`AMYCLAW_IMAGE_VERSION`**（当前量产默认 **`v2.0-release`**），写入 **`/etc/amyclaw-release`** 后打入镜像。 |
...
*文档版本：v2.0-release · 与镜像 `AMYCLAW_IMAGE_VERSION` 及仓库内其它文档并列维护*
