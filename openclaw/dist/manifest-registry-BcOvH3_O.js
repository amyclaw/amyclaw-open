import { d as isRecord, g as resolveConfigDir, y as resolveUserPath } from "./utils-BMtC0Ocd.js";
import { l as isPathInside$1, r as openBoundaryFileSync } from "./boundary-file-read-Y1cMjPlu.js";
import { n as resolveOpenClawPackageRootSync } from "./openclaw-root-0nFkqMDM.js";
import { r as normalizePluginsConfig } from "./config-state-sYURQqD8.js";
...
function resolveClaudeSkillDirs(raw, rootDir) {
	return mergeBundlePathLists(resolveClaudeSkillsRootDirs(raw, rootDir), resolveClaudeCommandRootDirs(raw, rootDir));
}
...
//#endregion
export { resolvePackageExtensionEntries as _, resolvePluginCacheInputs as a, safeStatSync as c, CURSOR_BUNDLE_MANIFEST_RELATIVE_PATH as d, detectBundleManifestFormat as f, loadPluginManifest as g, normalizeBundlePathList as h, discoverOpenClawPlugins as i, CLAUDE_BUNDLE_MANIFEST_RELATIVE_PATH as l, mergeBundlePathLists as m, loadPluginManifestRegistry as n, resolvePluginSourceRoots as o, loadBundleManifest as p, clearPluginDiscoveryCache as r, isPathInside as s, clearPluginManifestRegistryCache as t, CODEX_BUNDLE_MANIFEST_RELATIVE_PATH as u };
