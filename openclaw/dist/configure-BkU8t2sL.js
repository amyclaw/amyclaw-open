...
import { S as shortenHomePath, y as resolveUserPath } from "./utils-BMtC0Ocd.js";
import { Pn as resolvePluginProviders, T as listChannelPlugins, w as getChannelPlugin, wE as ensureAuthProfileStore } from "./auth-profiles-Bc6TPi0n.js";
import { g as resolveDefaultAgentWorkspaceDir } from "./workspace-Dns6NMt3.js";
import { d as readConfigFileSnapshot, g as writeConfigFile, s as loadConfig } from "./io-CezuVcrG.js";
import { o as isSecretRef, s as isValidEnvSecretRefId } from "./types.secrets-DuSPmmWB.js";
import { l as resolveDefaultSecretProviderAlias } from "./ref-contract-D96lSYLs.js";
import { w as findTailscaleBinary } from "./config-SJMQwqYd.js";
import { t as formatCliCommand } from "./command-format-C8aJknFW.js";
import { Mt as applyPrimaryModel } from "./provider-models-Cym0TctV.js";
...
import { a as ensureWorkspaceAndSessions, b as waitForGatewayReachable, f as printWizardHeader, g as resolveControlUiLinks, m as randomToken, n as applyWizardMetadata, p as probeGatewayReachable, s as guardCancel, t as DEFAULT_WORKSPACE, u as normalizeGatewayTokenInput, v as summarizeExistingConfig, y as validateGatewayPasswordInput } from "./onboard-helpers-vGwtm3SO.js";
import { n as resolveGatewayService, t as describeGatewayServiceRestart } from "./service-KUbBlQEC.js";
import { n as isNonFatalSystemdInstallProbeError } from "./systemd-D9tFr0-S.js";
import { t as WizardCancelledError } from "./prompts-DHs_x86z.js";
import { r as healthCommand } from "./health-C8SZ7cuw.js";
import { t as ensureControlUiAssetsBuilt } from "./control-ui-assets-CAky_mgS.js";
import { t as resolveSetupSecretInputString } from "./setup.secret-input-C884i-5V.js";
import { t as createClackPrompter } from "./clack-prompter-CGqWkGcW.js";
import { n as resolveProviderPluginChoice } from "./provider-wizard-DBroWtXB.js";
import { t as promptAuthChoiceGrouped } from "./auth-choice-prompt-BI3KrQyV.js";
import { t as resolvePreferredProviderForAuthChoice } from "./provider-auth-choice-preference-JPrlG7VU.js";
import { n as applyAuthChoice } from "./auth-choice-DcswpNxw.js";
import { n as setupChannels, t as noteChannelStatus } from "./onboard-channels-DkC9OVk_.js";
import { t as ensureSystemdUserLingerInteractive } from "./systemd-linger-BWp9Svas.js";
import { i as promptModelAllowlist, n as applyModelFallbacksFromSelection, r as promptDefaultModel, t as applyModelAllowlist } from "./model-picker-BmMbEKhh.js";
import { i as promptCustomApiConfig } from "./onboard-custom-BrkH2w3e.js";
import { a as maybeAddTailnetOriginToControlUiAllowedOrigins, i as TAILSCALE_MISSING_BIN_NOTE_LINES, n as TAILSCALE_DOCS_LINES, r as TAILSCALE_EXPOSURE_OPTIONS, t as validateIPv4AddressInput } from "./ipv4-CXbnunu0.js";
import { t as formatHealthCheckFailure } from "./health-format-DhsBYdbp.js";
import { t as promptRemoteGatewayConfig } from "./onboard-remote-CzFRfqTj.js";
import { t as setupSkills } from "./onboard-skills-BvenrHhd.js";
...
async function promptWebToolsConfig(nextConfig, runtime) {
	...
	const { SEARCH_PROVIDER_OPTIONS, resolveExistingKey, hasExistingKey, applySearchKey, hasKeyInEnv } = await import("./onboard-search-BDzLV_vq.js");
	const defaultProvider = SEARCH_PROVIDER_OPTIONS[0]?.value;
	if (!defaultProvider) throw new Error("No web search providers are registered.");
	...
	const existingProvider = (() => {
		...
		if (stored && SEARCH_PROVIDER_OPTIONS.some((e) => e.value === stored)) return stored;
		return SEARCH_PROVIDER_OPTIONS.find((e) => hasKeyForProvider(e.value))?.value ?? defaultProvider;
	})();
	note$1([
	...
	if (enableSearch) {
		const providerChoice = guardCancel(await select$1({
			...
			options: SEARCH_PROVIDER_OPTIONS.map((entry) => {
		...
		const keyInput = guardCancel(await text$1({
			message: keyConfigured ? envAvailable ? `${entry.label} API key (leave blank to keep current or use ${envVarNames})` : `${entry.label} API key (leave blank to keep current)` : envAvailable ? `${entry.label} API key (paste it here; leave blank to use ${envVarNames})` : `${entry.label} API key`,
			placeholder: keyConfigured ? "Leave blank to keep current" : entry.placeholder
		}), runtime);
		const key = String(keyInput ?? "").trim();
		if (key || existingKey) nextSearch = { ...applySearchKey(nextConfig, providerChoice, key || existingKey).tools?.web?.search };
		else if (keyConfigured || envAvailable) nextSearch = { ...nextSearch };
		else note$1([
