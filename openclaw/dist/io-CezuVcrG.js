import { _ as resolveStateDir, c as resolveDefaultConfigCandidates, n as DEFAULT_GATEWAY_PORT, o as resolveConfigPath, v as expandHomePrefix, x as resolveRequiredHomeDir } from "./paths-1qR_mW4i.js";
import { t as isTruthyEnvValue } from "./env-DlREndPb.js";
import { D as isPlainObject$2, d as isRecord$1, g as resolveConfigDir, y as resolveUserPath } from "./utils-BMtC0Ocd.js";
import { D as DEFAULT_CONTEXT_TOKENS, d as parseModelRef, w as normalizeProviderId } from "./model-selection-DJOYg7Dx.js";
import { m as resolveDefaultAgentId, p as resolveAgentWorkspaceDir, x as resolveAgentModelPrimaryValue } from "./agent-scope-B-OyGztR.js";
import { c as normalizeAgentId } from "./session-key-DyhRsRh-.js";
import { i as isBlockedObjectKey } from "./account-id-O4Og6DrK.js";
import { i as sanitizeHostExecEnv, n as isDangerousHostEnvVarName, r as normalizeEnvVarKey, t as isDangerousHostEnvOverrideVarName } from "./host-env-security-DnH8wzZ4.js";
...
import { n as containsEnvVarReference, r as resolveConfigEnvVars } from "./env-substitution--sbeMYae.js";
import { a as resolveMemorySlotDecision, i as resolveEffectiveEnableState, r as normalizePluginsConfig } from "./config-state-sYURQqD8.js";
import { a as ConfigIncludeError, c as resolveConfigIncludes, s as readConfigIncludeFileWithGuards, t as getBlockedNetworkModeReason } from "./network-mode-nTYy2WxO.js";
import { t as isSafeExecutableValue } from "./exec-safety-DZmujax0.js";
import { t as splitShellArgs } from "./shell-argv-C1FHz2HS.js";
import { c as normalizeChatChannelId, l as CHANNEL_IDS } from "./registry-jBzBWMf6.js";
import { n as loadPluginManifestRegistry } from "./manifest-registry-BcOvH3_O.js";
import { i as isCanonicalDottedDecimalIPv4, u as isLoopbackIpAddress } from "./ip-w605xvSx.js";
import { t as parseDurationMs } from "./parse-duration-6tk5MBqv.js";
import { A as TtsConfigSchema, D as ToolsMediaSchema, E as ToolsLinksSchema, F as requireOpenAllowFrom, I as sensitive, L as createAllowDenyChannelRulesSchema, N as TypingModeSchema, O as TranscribeAudioSchema, P as requireAllowlistAllowFrom, S as SecretInputSchema, T as SecretsConfigSchema, _ as ProviderCommandsSchema, a as DmPolicySchema, b as ReplyToModeSchema, c as GroupPolicySchema, d as IdentitySchema, f as InboundDebounceSchema, g as NativeCommandsSettingSchema, h as ModelsConfigSchema, i as DmConfigSchema, l as HexColorSchema, m as MarkdownConfigSchema, n as BlockStreamingCoalesceSchema, o as ExecutableTokenSchema, p as MSTeamsReplyStyleSchema, r as CliBackendSchema, s as GroupChatSchema, t as BlockStreamingChunkSchema, u as HumanDelaySchema, v as QueueSchema, w as SecretRefSchema, x as RetryConfigSchema } from "./zod-schema.core-CWxzqcUs.js";
...
//#endregion
export { isSupportedLocalAvatarExtension as $, formatSlackStreamModeMigrationMessage as $t, TELEGRAM_COMMAND_NAME_PATTERN as A, resolveAllowlistCandidatePath as At, resolveIMessageRemoteAttachmentRoots as B, normalizeExecutableToken as Bt, DiscordConfigSchema as C, resolveSubagentMaxConcurrent as Cn, isWindowsPlatform as Ct, SignalConfigSchema as D, shouldEnableShellEnvFallback as Dn, DEFAULT_SAFE_BINS as Dt, MSTeamsConfigSchema as E, resolveShellEnvFallbackTimeoutMs as En, splitCommandChainWithOperators as Et, isInboundPathAllowed as F, extractShellWrapperCommand as Ft, parseNonNegativeByteSize as G, POWERSHELL_INLINE_COMMAND_FLAGS as Gt, isSafeScpRemotePath as H, unwrapKnownDispatchWrapperInvocation as Ht, isValidInboundPathRootPattern as I, extractShellWrapperInlineCommand as It, AVATAR_MAX_BYTES as J, normalizeSafeBinProfileFixtures as Jt, ToolPolicySchema as K, resolveInlineCommandMatch as Kt, mergeInboundPathRoots as L, hasEnvManipulationBeforeShellWrapper as Lt, normalizeTelegramCommandName as M, resolveCommandResolutionFromArgv as Mt, resolveTelegramCustomCommands as N, resolveExecutableFromPathEnv as Nt, SlackConfigSchema as O, resolveOwnerDisplaySetting as On, matchAllowlist as Ot, DEFAULT_IMESSAGE_ATTACHMENT_ROOTS as P, POSIX_SHELL_WRAPPERS as Pt, isPathWithinRoot as Q, ensureControlUiAllowedOriginsForNonLoopbackBind as Qt, normalizeInboundPathRoots as R, isDispatchWrapperExecutable as Rt, WhatsAppConfigSchema as S, resolveAgentMaxConcurrent as Sn, buildSafeShellCommand as St, IMessageConfigSchema as T, getShellPathFromLoginShell as Tn, splitCommandChain as Tt, normalizeScpRemoteHost as U, unwrapKnownShellMultiplexerInvocation as Ut, isSafeScpRemoteHost as V, unwrapDispatchWrappersForResolution as Vt, normalizeScpRemotePath as W, POSIX_INLINE_COMMAND_FLAGS as Wt, isAvatarHttpUrl as X, applyMergePatch as Xt, isAvatarDataUrl as Y, resolveSafeBinProfiles as Yt, isAvatarImageDataUrl as Z, applyLegacyMigrations as Zt, validateConfigObject as _, resolveActiveTalkProviderConfig as _n, validateSafeBinArgv as _t, getRuntimeConfigSnapshot as a, parseStreamingMode as an, getConfigOverrides as at, validateConfigObjectWithPlugins as b, DEFAULT_SUBAGENT_MAX_CONCURRENT as bn, buildEnforcedShellCommand as bt, parseConfigJson5 as c, resolveSlackStreamingMode as cn, unsetConfigOverride as ct, readConfigFileSnapshot as d, createConfigRuntimeEnv as dn, setConfigValueAtPath as dt, formatSlackStreamingBooleanMigrationMessage as en, isWorkspaceRelativeAvatarPath as et, readConfigFileSnapshotForWrite as f, DEFAULT_TALK_PROVIDER as fn, unsetConfigValueAtPath as ft, writeConfigFile as g, readTalkApiKeyFromProfile as gn, normalizeTrustedSafeBinDirs as gt, setRuntimeConfigSnapshotRefreshHandler as h, normalizeTalkSection as hn, listWritableExplicitTrustedSafeBinDirs as ht, createConfigIO as i, parseSlackLegacyDraftStreamMode as in, applyConfigOverrides as it, normalizeTelegramCommandDescription as j, resolveCommandResolution as jt, TelegramConfigSchema as k, parseExecArgvToken as kt, projectConfigOntoRuntimeSourceSnapshot as l, resolveTelegramPreviewStreamMode as ln, getConfigValueAtPath as lt, setRuntimeConfigSnapshot as m, normalizeTalkConfig as mn, isTrustedSafeBinPath as mt, clearConfigCache as n, mapStreamingModeToSlackLegacyDraftStreamMode as nn, resolveAvatarMime as nt, getRuntimeConfigSourceSnapshot as o, resolveDiscordPreviewStreamMode as on, resetConfigOverrides as ot, resolveConfigSnapshotHash as p, buildTalkConfigResponse as pn, getTrustedSafeBinDirs as pt, parseByteSize as q, SAFE_BIN_PROFILES as qt, clearRuntimeConfigSnapshot as r, parseDiscordPreviewStreamMode as rn, validateJsonSchemaValue as rt, loadConfig as s, resolveSlackNativeStreaming as sn, setConfigOverride as st, ConfigRuntimeRefreshError as t, mapSlackLegacyDraftStreamModeToStreaming as tn, looksLikeAvatarPath as tt, readBestEffortConfig as u, collectConfigServiceEnvVars as un, parseConfigPath as ut, validateConfigObjectRaw as v, resolveTalkApiKey as vn, analyzeArgvCommand as vt, GoogleChatConfigSchema as w, getShellEnvAppliedKeys as wn, resolvePlannedSegmentArgv as wt, OpenClawSchema as x, DEFAULT_SUBAGENT_MAX_SPAWN_DEPTH as xn, buildSafeBinsShellCommand as xt, validateConfigObjectRawWithPlugins as y, DEFAULT_AGENT_MAX_CONCURRENT as yn, analyzeShellCommand as yt, resolveIMessageAttachmentRoots as z, isShellWrapperExecutable as zt };
