import { S as resolveOpenClawAgentDir } from "./setup-binary-nB5GxsnS.js";
import { Gm as applyAuthProfileConfig, Ig as normalizeApiKeyInput, Km as buildApiKeyCredential, Lg as normalizeSecretInputModeInput, Pg as ensureApiKeyFromOptionEnvOrPrompt, Rg as normalizeTokenProviderInput, Vg as validateApiKeyInput, n as resolveAuthProfileOrder, wE as ensureAuthProfileStore, xE as upsertAuthProfile } from "./auth-profiles-Bc6TPi0n.js";
import { r as applyProviderConfigWithDefaultModel, t as applyAgentDefaultModelPrimary } from "./provider-onboard-dAr3NUh2.js";
import { n as resolveManifestProviderAuthChoice, t as resolveManifestProviderApiKeyChoice } from "./provider-auth-choices-Dpj7HYAE.js";
import { t as createAuthChoiceDefaultModelApplierForMutableState } from "./auth-choice.apply-helpers-DmqoS3IO.js";
...
async function resolvePreferredProviderForAuthChoice(params) {
	...
	const { resolveProviderPluginChoice, resolvePluginProviders } = await import("./provider-auth-choice.runtime-Bq75_Rpm.js");
