import { Af as resolveTelegramExecApprovalTarget, BT as collectOpenGroupPolicyRouteAllowlistWarnings, Bf as sendTelegramPayloadMessages, Cm as normalizeTelegramMessagingTarget, FS as buildExecApprovalPendingReplyPayload, HT as clearAccountEntryFields, IT as collectAllowlistProviderGroupPolicyWarnings, Kx as resolveTelegramAccount, Mp as buildTelegramGroupPeerId, Of as isTelegramExecApprovalClientEnabled, Sm as looksLikeTelegramTargetId, Tr as resolveTelegramGroupToolPolicy, Vf as collectTelegramStatusIssues, Wx as listTelegramAccountIds, YC as buildTokenChannelStatusSummary, b_ as parseTelegramTopicConversation, bm as parseTelegramReplyToMessageId, dp as sendTypingTelegram, ew as projectCredentialSnapshotFields, gw as listTelegramDirectoryPeersFromConfig, hw as listTelegramDirectoryGroupsFromConfig, nw as resolveConfiguredFromCredentialStatuses, pT as createScopedDmSecurityResolver, uu as resolveOutboundSendDep, wm as parseTelegramTarget, wr as resolveTelegramGroupRequireMention, ww as PAIRING_APPROVED_MESSAGE, xm as parseTelegramThreadId, zS as resolveExecApprovalCommandDisplay } from "./auth-profiles-Bc6TPi0n.js";
...
import { n as collectTelegramUnmentionedGroupIds, t as auditTelegramGroupMembership } from "./audit-DTw2xid0.js";
...
import { n as monitorTelegramProvider, r as buildTelegramExecApprovalButtons, t as probeTelegram } from "./probe-BSrCgptr.js";
import { a as telegramSetupWizard, i as telegramConfigAccessors, n as findTelegramTokenOwnerAccountId, o as telegramSetupAdapter, r as formatDuplicateTelegramTokenReason, t as createTelegramPluginBase } from "./shared-BgGX2rQA.js";
	...
	lifecycle: {
		onAccountConfigChanged: async ({ prevCfg, nextCfg, accountId }) => {
			if (resolveTelegramAccount({
				...
				const { deleteTelegramUpdateOffset } = await import("./update-offset-store-BDGYlT-p.js");
