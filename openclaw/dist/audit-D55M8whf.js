...
import { ff as resolveMergedSafeBinProfileFixtures, uf as listInterpreterLikeSafeBins } from "./auth-profiles-Bc6TPi0n.js";
import { gt as normalizeTrustedSafeBinDirs } from "./io-CezuVcrG.js";
import { a as hasConfiguredSecretInput } from "./types.secrets-DuSPmmWB.js";
import { n as formatPermissionRemediation, r as inspectPathPermissions, t as formatPermissionDetail } from "./audit-fs-Cequ8jTw.js";
import { R as resolveSandboxConfigForAgent } from "./workspace-dirs-B6rDmzuU.js";
import { m as resolveGatewayAuth, n as resolveBrowserConfig, r as resolveProfile } from "./config-SJMQwqYd.js";
import { t as formatCliCommand } from "./command-format-C8aJknFW.js";
import { et as resolveBrowserControlAuth, f as redactCdpUrl } from "./routes-AlbnCYWi.js";
import { g as isBlockedHostnameOrIp, v as isPrivateNetworkAllowedByPolicy } from "./image-ops-DM56IRtp.js";
...
async function loadChannelPlugins() {
	channelPluginsModulePromise ??= import("./plugins-DrNGlw07.js");
	return await channelPluginsModulePromise;
}
async function loadAuditNonDeepModule() {
	auditNonDeepModulePromise ??= import("./audit.nondeep.runtime-CIC5XgCB.js");
	return await auditNonDeepModulePromise;
}
async function loadAuditDeepModule() {
	auditDeepModulePromise ??= import("./audit.deep.runtime-C2sUV5gc.js");
	return await auditDeepModulePromise;
}
async function loadAuditChannelModule() {
	auditChannelModulePromise ??= import("./audit-channel.collect.runtime-Db_Bk9ve.js");
	return await auditChannelModulePromise;
}
async function loadGatewayProbeDeps() {
	gatewayProbeDepsPromise ??= Promise.all([
		import("./call-DeA-y-R6.js"),
		import("./probe-auth-BSSAlJBl.js"),
		import("./probe-CxTc-TCy.js")
