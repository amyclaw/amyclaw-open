import { n as redactSensitiveText } from "./redact-fatrROh9.js";
import { n as extractErrorCode, r as formatErrorMessage } from "./errors-DOJWZqNo.js";
...
import { g as resolveConfigDir, l as escapeRegExp, t as CONFIG_DIR, y as resolveUserPath } from "./utils-BMtC0Ocd.js";
import { c as isNotFoundPathError, l as isPathInside } from "./boundary-file-read-Y1cMjPlu.js";
import { r as runExec } from "./exec-CwhzW0JB.js";
import { a as getRuntimeConfigSnapshot, g as writeConfigFile, i as createConfigIO, s as loadConfig } from "./io-CezuVcrG.js";
import { a as hasConfiguredSecretInput, d as resolveSecretInputRef } from "./types.secrets-DuSPmmWB.js";
import { u as secretRefKey } from "./ref-contract-D96lSYLs.js";
import { i as resolveSecretRefValues } from "./resolve-D7R3Obgc.js";
import { A as DEFAULT_AI_SNAPSHOT_MAX_CHARS, M as DEFAULT_OPENCLAW_BROWSER_PROFILE_NAME, a as allocateColor, c as isValidProfileName, i as allocateCdpPort, k as DEFAULT_AI_SNAPSHOT_EFFICIENT_MAX_CHARS, l as deriveDefaultBrowserCdpPortRange, m as resolveGatewayAuth, n as resolveBrowserConfig, o as getUsedColors, r as resolveProfile, s as getUsedPorts, t as parseHttpUrl } from "./config-SJMQwqYd.js";
import { t as formatCliCommand } from "./command-format-C8aJknFW.js";
import { r as isLoopbackHost } from "./net-B_Iq_SVP.js";
import { c as hasGatewayPasswordEnvCandidate, d as readGatewayTokenEnv, l as hasGatewayTokenEnvCandidate } from "./credentials-B7GJXbww.js";
import { r as ensurePortAvailable } from "./ports-D_2Jwnkx.js";
import { b as resolvePinnedHostnameWithPolicy, c as resizeToJpeg, i as getImageMetadata, n as buildImageResizeSideGrid, t as IMAGE_REDUCE_QUALITY_STEPS, u as SsrFBlockedError, v as isPrivateNetworkAllowedByPolicy, y as resolvePinnedHostname } from "./image-ops-DM56IRtp.js";
import { r as hasProxyEnvConfigured } from "./proxy-env-CpbYErbv.js";
import { a as openFileWithinRoot, c as readLocalFileSafely, t as SafeOpenError } from "./fs-safe-Ds1qsPxW.js";
import { n as extensionForMime, t as detectMime } from "./mime-_IkgFMS2.js";
...
async function loadPwAiModule(mode) {
	try {
		return await import("./pw-ai-sgjmu3WU.js");
	} catch (err) {
...
function createProfileAvailability({ opts, profile, state, getProfileState, setProfileRunning }) {
	...
	const closePlaywrightBrowserConnectionForProfile = async (cdpUrl) => {
		try {
			await (await import("./pw-ai-sgjmu3WU.js")).closePlaywrightBrowserConnection(cdpUrl ? { cdpUrl } : void 0);
		} catch {}
	};
...
async function stopBrowserRuntime(params) {
	...
	try {
		await (await import("./pw-ai-sgjmu3WU.js")).closePlaywrightBrowserConnection();
	} catch {}
}
//#endregion
...
//#endregion
export { ensureBrowserControlAuth as $, cleanOldMedia as A, resolveStrictExistingPathsWithinRoot as B, parseBrowserMajorVersion as C, withNoProxyForCdpUrl as D, markPwAiLoaded as E, saveMediaSource as F, normalizeBrowserFormFieldValue as G, getBrowserProfileCapabilities as H, setMediaStoreNetworkDepsForTest as I, assertBrowserNavigationRedirectChainAllowed as J, BrowserTabNotFoundError as K, DEFAULT_TRACE_DIR as L, extractOriginalFilename as M, getMediaDir as N, MEDIA_MAX_BYTES as O, saveMediaBuffer as P, setBridgeAuthForPort as Q, DEFAULT_UPLOAD_DIR as R, getChromeWebSocketUrl as S, resolveGoogleChromeExecutableForPlatform as T, DEFAULT_FILL_FIELD_TYPE as U, matchBrowserUrlPattern as V, normalizeBrowserFormField as W, withBrowserNavigationPolicy as X, assertBrowserNavigationResultAllowed as Y, deleteBridgeAuthForPort as Z, startBrowserControlServiceFromConfig as _, parseRoleRef as a, resolveConfiguredSecretInputWithFallback as at, createBrowserRouteContext as b, appendCdpPath as c, hasAmbiguousGatewayAuthModeConfig as ct, normalizeCdpHttpBaseForJsonEndpoints as d, resolveBrowserControlAuth as et, redactCdpUrl as f, createBrowserControlContext as g, createBrowserRouteDispatcher as h, getRoleSnapshotStats as i, resolveConfiguredSecretInputString as it, ensureMediaDir as j, SaveMediaSourceError as k, fetchJson as l, fetchBrowserJson as m, buildRoleSnapshotFromAiSnapshot as n, mergeGatewayAuthConfig as nt, formatAriaSnapshot as o, resolveRequiredConfiguredSecretRefInputString as ot, withCdpSocket as p, assertBrowserNavigationAllowed as q, buildRoleSnapshotFromAriaSnapshot as r, mergeGatewayTailscaleConfig as rt, normalizeCdpWsUrl as s, assertExplicitGatewayAuthModeWhenBothConfigured as st, registerBrowserRoutes as t, ensureGatewayStartupAuth as tt, getHeadersWithAuth as u, createBrowserRuntimeState as v, readBrowserVersion as w, movePathToTrash as x, stopBrowserRuntime as y, resolveExistingPathsWithinRoot as z };
