...
import { bS as readRequestBodyWithLimit, vS as isRequestBodyLimitError, xS as requestBodyErrorToText } from "../../auth-profiles-Bc6TPi0n.js";
...
import { A as TtsConfigSchema } from "../../zod-schema.core-CWxzqcUs.js";
  ...
  <Play loop="0">https://s3.amazonaws.com/com.twilio.music.classical/BusyStrings.mp3</Play>
	...
	*/
	async handleInboundResponse(callId, userMessage) {
		...
		try {
			const { generateVoiceResponse } = await import("../../response-generator-CWzLsBzZ.js");
