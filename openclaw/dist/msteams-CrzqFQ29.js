...
import { Ag as setTopLevelChannelDmPolicyWithAllowFrom, Mg as splitSetupEntries, jg as setTopLevelChannelGroupPolicy, kg as setTopLevelChannelAllowFrom, ug as mergeAllowFromEntries } from "./auth-profiles-Bc6TPi0n.js";
...
async function loadMSTeamsSdk() {
	return await import("./src-Bu6mxYqp.js").then((m) => /* @__PURE__ */ __toESM(m.default, 1));
}
