...
import { n as generateSecureUuid } from "./secure-random-BKKzr8he.js";
...
async function loadPendingDeliveries(stateDir) {
	...
	for (const file of files) {
		if (!file.endsWith(".delivered")) continue;
...
//#endregion
export { failDelivery as a, loadPendingDeliveries as c, ensureQueueDir as i, moveToFailed as l, computeBackoffMs as n, isEntryEligibleForRecoveryRetry as o, enqueueDelivery as r, isPermanentDeliveryError as s, ackDelivery as t, recoverPendingDeliveries as u };
