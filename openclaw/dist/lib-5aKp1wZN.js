...
import { t as require_src } from "./src-DWQI1xVs.js";
import { C as UINT32_LE, a as UnsupportedFileTypeError, i as InternalParserError, k as textDecode, n as CouldNotDetermineFileTypeError } from "./BasicParser-BFdF6AVD.js";
import { t as fromBuffer } from "./lib-CQU7SSNv.js";
import { l as toRatio, n as decodeString } from "./Util-BYvKTITf.js";
import { c as TimestampFormat, i as LyricsContentType } from "./ID3v2Token-4-F8W1Lr.js";
import { t as APEv2Parser } from "./APEv2Parser-6TAAx9hE.js";
import { r as hasID3v1Header } from "./ID3v1Parser-DNBEu1sO.js";
import { n as TrackType, r as TrackTypeValueToKeyMap } from "./types-DoKilSxv.js";
...
const mpegParserLoader = {
	...
	async load() {
		return (await import("./MpegParser-D6hoiZh1.js")).MpegParser;
	}
};
//#endregion
...
const apeParserLoader = {
	...
	async load() {
		return (await import("./APEv2Parser-B3M85hGP.js")).APEv2Parser;
	}
};
//#endregion
...
const asfParserLoader = {
	...
	async load() {
		return (await import("./AsfParser-BykB5oI9.js")).AsfParser;
	}
};
//#endregion
...
const dsdiffParserLoader = {
	...
	async load() {
		return (await import("./DsdiffParser-CL9PTZiz.js")).DsdiffParser;
	}
};
//#endregion
...
const aiffParserLoader = {
	...
	async load() {
		return (await import("./AiffParser-CfHYcXY9.js")).AIFFParser;
	}
};
//#endregion
...
const dsfParserLoader = {
	...
	mimeTypes: ["audio/dsf"],
	async load() {
		return (await import("./DsfParser-BrXDk3Ta.js")).DsfParser;
	}
};
//#endregion
...
const flacParserLoader = {
	...
	async load() {
		return (await import("./FlacParser-YwF4Wnl7.js")).FlacParser;
	}
};
//#endregion
...
const matroskaParserLoader = {
	...
	async load() {
		return (await import("./MatroskaParser-CGHYr5Uh.js")).MatroskaParser;
	}
};
//#endregion
...
const mp4ParserLoader = {
	...
	async load() {
		return (await import("./MP4Parser-CFSHi1ei.js")).MP4Parser;
	}
};
//#endregion
...
const musepackParserLoader = {
	...
	async load() {
		return (await import("./MusepackParser-CIvVdd8a.js")).MusepackParser;
	}
};
//#endregion
...
const oggParserLoader = {
	...
	async load() {
		return (await import("./OggParser-JQ7FK3uq.js")).OggParser;
	}
};
//#endregion
...
const wavpackParserLoader = {
	...
	async load() {
		return (await import("./WavPackParser-BfWAjGne.js")).WavPackParser;
	}
};
//#endregion
...
const riffParserLoader = {
	...
	async load() {
		return (await import("./WaveParser-CB0Apxf5.js")).WaveParser;
	}
};
//#endregion
...
(0, import_src.default)("music-metadata:parser");
//#endregion
export { parseBuffer };
