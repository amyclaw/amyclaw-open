import { AT as formatPairingApproveHint, XC as collectStatusIssuesFromLastError, ZC as createDefaultChannelRuntimeState, gT as mapAllowFromEntries } from "./auth-profiles-Bc6TPi0n.js";
...
import { a as resolveNostrAccount, c as getNostrRuntime, d as NostrConfigSchema, i as resolveDefaultNostrAccountId, n as nostrSetupWizard, o as normalizePubkey, r as listNostrAccountIds, s as startNostrBus, t as nostrSetupAdapter } from "./nostr-C_koa36y.js";
import { r as buildTrafficStatusSummary, t as buildPassiveChannelStatusSummary } from "./channel-status-summary-CqaCAvAP.js";
...
const nostrPlugin = {
	...
	config: {
		...
		resolveAllowFrom: ({ cfg, accountId }) => mapAllowFromEntries(resolveNostrAccount({
			cfg,
			accountId
		}).config.allowFrom),
