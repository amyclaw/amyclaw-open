...
import { h as restoreTerminalState, m as defaultRuntime } from "./subsystem-MGyxt_Bl.js";
...
import { s as isValidEnvSecretRefId } from "./types.secrets-DuSPmmWB.js";
...
import "./daemon-runtime-BPknjyQD.js";
import { a as ensureWorkspaceAndSessions, b as waitForGatewayReachable, c as handleReset, g as resolveControlUiLinks, m as randomToken, n as applyWizardMetadata, t as DEFAULT_WORKSPACE, u as normalizeGatewayTokenInput } from "./onboard-helpers-vGwtm3SO.js";
...
import { i as resolveManifestProviderOnboardAuthFlags } from "./provider-auth-choices-Dpj7HYAE.js";
import { n as isDeprecatedAuthChoice, r as normalizeLegacyOnboardAuthChoice } from "./auth-choice-legacy-D-JzszIe.js";
import { r as applyLocalSetupWorkspaceConfig } from "./onboard-config-h17nGdPj.js";
...
async function collectGatewayHealthFailureDiagnostics() {
	const diagnostics = {};
	try {
		const { resolveGatewayService } = await import("./service-DwulT0Ic.js");
	...
	try {
		const { readLastGatewayErrorLine } = await import("./diagnostics-DVnU_o3X.js");
...
async function runNonInteractiveLocalSetup(params) {
	...
	if (authChoice !== "skip") {
		const { applyNonInteractiveAuthChoice } = await import("./auth-choice-wV6_FPg6.js");
	...
	if (opts.installDaemon) {
		const { installGatewayDaemonNonInteractive } = await import("./daemon-install-B-27fsAg.js");
