import { FT as buildOpenGroupPolicyWarning, IT as collectAllowlistProviderGroupPolicyWarnings, XC as collectStatusIssuesFromLastError, dT as createScopedAccountConfigAccessors, fT as createScopedChannelConfigBase, ig as buildSecretInputSchema, pT as createScopedDmSecurityResolver, qC as buildProbeChannelStatusSummary, ww as PAIRING_APPROVED_MESSAGE } from "./auth-profiles-Bc6TPi0n.js";
...
import { c as GroupPolicySchema, m as MarkdownConfigSchema } from "./zod-schema.core-CWxzqcUs.js";
...
import { i as buildNestedDmConfigSchema, r as buildChannelConfigSchema, t as AllowFromListSchema } from "./config-schema-GQ6uWjXe.js";
import { _ as isBunRuntime, a as resolveDefaultMatrixAccountId, i as listMatrixAccountIds, m as resolveMatrixAuth, n as matrixSetupAdapter, o as resolveMatrixAccount, s as resolveMatrixAccountConfig, t as matrixSetupWizard, u as resolveSharedMatrixClient } from "./matrix-B69n40Oi.js";
import { s as getMatrixRuntime } from "./credentials-CgJiOMDt.js";
import { r as buildTrafficStatusSummary } from "./channel-status-summary-CqaCAvAP.js";
import { c as getActiveMatrixClient, n as sendMessageMatrix, o as resolveMatrixRoomId, s as createPreparedMatrixClient, t as reactMatrixMessage } from "./send-DAjs2RiG.js";
import { a as resolveMatrixRoomConfig, c as summarizeMatrixRawEvent, d as RelationType, l as EventType, n as normalizeMatrixUserId, o as fetchEventSummary, s as readPinnedEvents, t as normalizeMatrixAllowList, u as MsgType } from "./allowlist-pAQbNFny.js";
import { z } from "zod";
...
const loadMatrixChannelRuntime = createLazyRuntimeSurface(() => import("./channel.runtime-YQsUAS94.js"), ({ matrixChannelRuntime }) => matrixChannelRuntime);
const meta = {
	id: "matrix",
	label: "Matrix",
...
const matrixPlugin = {
	...
	gateway: { startAccount: async (ctx) => {
		...
		try {
			monitorMatrixProvider = (await import("./matrix-DTexLHaF.js")).monitorMatrixProvider;
		} finally {
			releaseLock();
		}
