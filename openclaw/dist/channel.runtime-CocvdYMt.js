...
import { Ah as createScopedPairingAccess, Nd as resolveDmGroupAccessWithLists, Oh as issuePairingChallenge, bs as resolveMentionGatingWithBypass, sg as createReplyPrefixOptions, tC as isDangerousNameMatchingEnabled, vh as createWebhookInFlightLimiter, yh as readJsonWebhookBodyOrReject } from "./auth-profiles-Bc6TPi0n.js";
...
import { i as resolveWebhookTargetWithAuthOrReject, l as resolveWebhookPath, n as registerWebhookTargetWithPluginRoute, s as withResolvedWebhookRequestPipeline } from "./webhook-targets-CXPKfaOD.js";
...
import { c as sendGoogleChatMessage, d as verifyGoogleChatRequest, i as downloadGoogleChatMedia, l as updateGoogleChatMessage, n as deleteGoogleChatMessage, s as probeGoogleChat, u as uploadGoogleChatAttachment } from "./api-BL3WBtIv.js";
...
async function deliverGoogleChatReply(params) {
	...
	if (payload.text) {
		...
		for (let i = 0; i < chunks.length; i++) {
			...
			try {
				if (i === 0 && typingMessageName) await updateGoogleChatMessage({
					account,
					messageName: typingMessageName,
					text: chunk
				});
...
async function uploadAttachmentForReply(params) {
	...
	const { uploadGoogleChatAttachment } = await import("./api-D4-teECR.js");
