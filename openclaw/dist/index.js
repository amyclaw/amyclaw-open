...
import { t as installUnhandledRejectionHandler } from "./unhandled-rejections-BT0Rsc03.js";
import process from "node:process";
import { fileURLToPath } from "node:url";
//#region src/index.ts
const library = await import("./library-BPom_Cdf.js");
...
async function runLegacyCliEntry(argv = process.argv) {
	const [{ installGaxiosFetchCompat }, { runCli }] = await Promise.all([import("./gaxios-fetch-compat-Cgtx8Se2.js"), import("./run-main-Dlf0idRH.js")]);
