import { Fm as formatTokenK, Vb as loadModelCatalog, ax as hasUsableCustomProviderApiKey, lx as resolveEnvApiKey, vE as listProfilesForProvider, wE as ensureAuthProfileStore } from "./auth-profiles-Bc6TPi0n.js";
import { O as DEFAULT_MODEL, c as modelKey, k as DEFAULT_PROVIDER, m as resolveConfiguredModelRef, r as buildModelAliasIndex, t as buildAllowedModelSet, w as normalizeProviderId } from "./model-selection-DJOYg7Dx.js";
...
async function loadModelPickerRuntime() {
	return import("./model-picker.runtime-fUZsskZP.js");
}
...
async function promptDefaultModel(params) {
	...
	if (hasPreferredProvider && preferredProvider) models = models.filter((entry) => {
