import { o as getResolvedLoggerSettings } from "./logger-ByBU4z1U.js";
import { _ as resolveStateDir, d as resolveIsNixMode, h as resolveOAuthDir, t as CONFIG_PATH, u as resolveGatewayPort, x as resolveRequiredHomeDir } from "./paths-1qR_mW4i.js";
import { m as defaultRuntime } from "./subsystem-MGyxt_Bl.js";
import { t as isTruthyEnvValue$1 } from "./env-DlREndPb.js";
import { C as sleep, S as shortenHomePath, y as resolveUserPath } from "./utils-BMtC0Ocd.js";
import { h as isWSLEnv, p as isWSL } from "./setup-binary-nB5GxsnS.js";
import { $a as DEFAULT_OAUTH_WARN_MS, $c as buildBootstrapInjectionStats, AE as updateAuthProfileStoreWithLock, Ad as resolveDmAllowState, Fn as loadOpenClawPlugins, LC as loadCronStore, Pn as resolvePluginProviders, Qc as analyzeBootstrapBudget, RC as resolveCronStorePath, T as listChannelPlugins, Vb as loadModelCatalog, ch as hasConfiguredMemorySecretInput, d as resolveProfileUnusableUntilForDisplay, eo as buildAuthHealthSummary, fE as resolveBootstrapMaxChars, hE as repairOAuthProfileIdMismatch, km as noteOpenAIOAuthTlsPrerequisites, mE as resolveApiKeyForProfile, mf as resolveBootstrapContextForRun, pE as resolveBootstrapTotalMaxChars, rC as loadSessionStore, sx as resolveApiKeyForProvider, to as formatRemainingShort, wE as ensureAuthProfileStore, y as resolveAgentSessionDirs, zC as saveCronStore } from "./auth-profiles-Bc6TPi0n.js";
import { O as DEFAULT_MODEL, g as resolveHooksGmailModel, i as getModelRefStatus, k as DEFAULT_PROVIDER, m as resolveConfiguredModelRef } from "./model-selection-DJOYg7Dx.js";
import { a as resolveAgentDir, m as resolveDefaultAgentId, p as resolveAgentWorkspaceDir } from "./agent-scope-B-OyGztR.js";
...
import { t as DEFAULT_AGENTS_FILENAME } from "./workspace-Dns6NMt3.js";
...
import { P as cleanStaleLockFiles, at as DEFAULT_SANDBOX_IMAGE, rt as DEFAULT_SANDBOX_BROWSER_IMAGE, z as resolveSandboxScope } from "./workspace-dirs-B6rDmzuU.js";
import { m as resolveGatewayAuth } from "./config-SJMQwqYd.js";
...
import { d as readGatewayTokenEnv } from "./credentials-B7GJXbww.js";
import { C as parseBrowserMajorVersion, T as resolveGoogleChromeExecutableForPlatform, at as resolveConfiguredSecretInputWithFallback, ct as hasAmbiguousGatewayAuthModeConfig, w as readBrowserVersion } from "./routes-AlbnCYWi.js";
...
import { f as resolveMainSessionKey } from "./lazy-runtime-07jXxTa3.js";
import { c as resolveSessionTranscriptsDirForAgent, i as resolveSessionFilePathOptions, l as resolveStorePath, r as resolveSessionFilePath } from "./paths-BumENdHQ.js";
import { n as callGateway, t as buildGatewayConnectionDetails } from "./call-x5WvUEsz.js";
import { t as resolveMemorySearchConfig } from "./memory-search-CHMV_-Bg.js";
import { r as resolveMemoryBackendConfig } from "./search-manager-ByZ9OOyz.js";
import { n as logConfigUpdated } from "./logging-imcVaYUC.js";
import { i as stylePromptTitle, n as stylePromptHint, r as stylePromptMessage, t as note$1 } from "./note-aKR6kEr4.js";
import { f as resolveGatewaySystemdServiceName, h as resolveNodeLaunchAgentLabel, l as resolveGatewayLaunchAgentLabel, p as resolveGatewayWindowsTaskName } from "./constants-lVyWfBza.js";
import { a as resolveSystemNodeInfo, r as renderSystemNodeWarning } from "./runtime-paths-_CSjQVsn.js";
import { n as buildGatewayInstallPlan, r as gatewayInstallErrorHint, t as resolveGatewayInstallToken } from "./gateway-install-token-BGt0we7S.js";
import { n as GATEWAY_DAEMON_RUNTIME_OPTIONS, t as DEFAULT_GATEWAY_DAEMON_RUNTIME } from "./daemon-runtime-BPknjyQD.js";
import { f as printWizardHeader, m as randomToken, n as applyWizardMetadata, s as guardCancel } from "./onboard-helpers-vGwtm3SO.js";
import { i as launchAgentPlistExists, n as isLaunchAgentListed, r as isLaunchAgentLoaded, s as repairLaunchAgentBootstrap } from "./launchd-5_vi_uEh.js";
import { n as resolveGatewayService, t as describeGatewayServiceRestart } from "./service-KUbBlQEC.js";
import { i as isSystemdUserServiceAvailable, u as uninstallLegacySystemdUnits } from "./systemd-D9tFr0-S.js";
import { c as buildPlatformRuntimeLogHints, i as auditGatewayServiceConfig, n as renderSystemdUnavailableHints, o as needsNodeRuntimeMigration, r as SERVICE_AUDIT_CODES, s as readEmbeddedGatewayToken, t as isSystemdUnavailableDetail, u as formatRuntimeStatus } from "./systemd-hints-CfA12Ack.js";
import { t as readLastGatewayErrorLine } from "./diagnostics-B0pY3AcB.js";
import { n as renderGatewayServiceCleanupHints, t as findExtraGatewayServices } from "./inspect-DSc4PckQ.js";
import { t as buildWorkspaceSkillStatus } from "./skills-status-DR3A1KMJ.js";
import { r as healthCommand } from "./health-C8SZ7cuw.js";
import { i as resolveControlUiDistIndexPathForRoot, r as resolveControlUiDistIndexHealth } from "./control-ui-assets-CAky_mgS.js";
import { p as normalizeStoredCronJobs, t as runGatewayUpdate } from "./update-runner-m7qOwuqA.js";
import { t as collectChannelStatusIssues } from "./channels-status-issues-Stv_zyuM.js";
import { n as resolveProviderAuthLoginCommand, t as buildProviderAuthRecoveryHint } from "./provider-auth-guidance-070edE4a.js";
import { t as ensureSystemdUserLingerInteractive } from "./systemd-linger-BWp9Svas.js";
import { t as formatHealthCheckFailure } from "./health-format-DhsBYdbp.js";
import { n as doctorShellCompletion } from "./doctor-completion-l0y24Z-T.js";
import { a as runLegacyStateMigrations, i as detectLegacyStateMigrations, r as loadAndMaybeMigrateDoctorConfig } from "./doctor-config-flow-B6erH_L3.js";
import { t as resolveDefaultChannelAccountContext } from "./channel-account-context-Bh06P2HY.js";
