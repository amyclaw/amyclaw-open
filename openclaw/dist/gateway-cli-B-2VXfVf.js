import { i as compileConfigRegex, l as testRegexWithBoundedInput } from "./redact-fatrROh9.js";
import { a as hasErrnoCode, r as formatErrorMessage } from "./errors-DOJWZqNo.js";
import { a as registerUnhandledRejectionHandler } from "./unhandled-rejections-BT0Rsc03.js";
import { a as getLogger, i as getChildLogger, o as getResolvedLoggerSettings } from "./logger-ByBU4z1U.js";
import { _ as resolveStateDir, i as isNixMode, l as resolveGatewayLockDir, o as resolveConfigPath, r as STATE_DIR, t as CONFIG_PATH, u as resolveGatewayPort } from "./paths-1qR_mW4i.js";
import "./tmp-openclaw-dir-BDQ0wJ2G.js";
import { n as isRich, r as theme, t as colorize } from "./theme-BSXzMzAA.js";
import { a as logVerbose, s as setVerbose } from "./globals-DqZvRoPX.js";
import { d as setConsoleTimestampPrefix, m as defaultRuntime, r as runtimeForLogger, t as createSubsystemLogger, u as setConsoleSubsystemFilter } from "./subsystem-MGyxt_Bl.js";
import { t as sanitizeForLog } from "./ansi-BPhP6LBZ.js";
import "./boolean-D8Ha5nYV.js";
import { n as logAcceptedEnvOption, t as isTruthyEnvValue } from "./env-DlREndPb.js";
import "./warning-filter-Cg8_xqcp.js";
import { C as sleep, D as isPlainObject, E as truncateUtf16Safe, S as shortenHomePath, c as ensureDir, l as escapeRegExp, r as clamp, y as resolveUserPath } from "./utils-BMtC0Ocd.js";
...
import { $_ as resolveTtsProviderOrder, $u as normalizeOptionalText$1, A as releasePinnedPluginHttpRouteRegistry, AS as resolveHeartbeatDeliveryTarget, Al as loadProviderUsageSummary, Au as emitGatewayRestart, BS as sanitizeExecApprovalDisplayText, Bl as migrateAndPruneGatewaySessionStoreKey, Bn as applyPluginAutoEnable, C as snapshotSessionOrigin, CC as resolveSessionTranscriptCandidates, CS as emitHeartbeatEvent, C_ as DEFAULT_INPUT_IMAGE_MAX_BYTES, Cf as setCommandLaneConcurrency, Cs as canonicalizePathForSecurity, D as getActivePluginRegistry, DC as stripInlineDirectiveTagsFromMessageForDisplay, D_ as extractImageContentFromSource, Dl as resolveAnnounceTargetFromKey, Dn as supportsXHighThinking, Ds as createReplyDispatcher, Du as resolveFailoverReasonFromError, Dv as normalizeSendPolicy, Dx as resolveUserTimezone, E as normalizeChannelId, EC as stripInlineDirectiveTagsForDisplay, ES as resolveIndicatorType, E_ as extractFileContentFromSource, Ec as registerSkillsChangeListener, El as readLatestAssistantReply, Ex as resolveCronStyleNow, Fa as dispatchInboundMessage, Fn as loadOpenClawPlugins, Fu as setPreRestartDeferralCheck, G_ as isTtsProviderConfigured, Ga as getCliSessionId, Gu as normalizeCronJobCreate, H_ as getTtsProvider, Hl as resolveSessionModelRef, Ic as countActiveDescendantRuns, Il as listAgentsForGateway, Iu as triggerOpenClawRestart, Jc as abortEmbeddedPiRun, Jd as buildSystemRunApprovalEnvBinding, Ju as resolveCronStaggerMs, KS as computeBackoff, Ka as setCliSessionId, Kc as clearSessionQueues, Kd as resolveSystemRunCommandRequest, Ku as normalizeCronJobPatch, LC as loadCronStore, Lb as extractTextFromChatContent, Ld as GATEWAY_AUTH_SURFACE_PATHS, Ll as listSessionsFromStore, Lu as consumeRestartSentinel, M as resolveActivePluginHttpRouteRegistry, MS as resolveOutboundTarget, MT as resolveChannelDefaultAccountId, Mu as markGatewaySigusr1RestartHandled, N as createEmptyPluginRegistry, NS as resolveSessionDeliveryTarget, Nu as scheduleGatewaySigusr1Restart, OC as jsonUtf8Bytes, OT as normalizeWhatsAppTarget, O_ as normalizeMimeList, Ol as resolveNestedAgentLane, Ou as consumeGatewaySigusr1RestartAuthorization, Ov as resolveSendPolicy, PC as applyModelOverrideToSessionEntry, PS as resolveOutboundChannelPlugin, Pa as resolveHeartbeatReplyPayload, Pl as canonicalizeSpawnedByForAgent, Pu as setGatewaySigusr1RestartPolicy, Pv as runGlobalGatewayStopSafely, Pw as buildChannelUiCatalog, Q_ as resolveTtsPrefsPath, Qd as toSystemRunApprovalMismatchError, Qu as normalizeOptionalSessionKey, RC as resolveCronStorePath, Rd as evaluateGatewayAuthSurfaceStates, Rl as loadCombinedSessionStoreForGateway, Ru as formatDoctorNonInteractiveHint, S as resolveMainSessionKeyFromConfig, SC as readSessionPreviewItemsFromTranscript, SS as resolveHeartbeatVisibility, Sf as resetAllLanes, Ss as PROTECTED_PLUGIN_ROUTE_PREFIXES, T as listChannelPlugins, TC as stripEnvelopeFromMessages, TS as onHeartbeatEvent, T_ as DEFAULT_INPUT_TIMEOUT_MS, Tc as getSkillsSnapshotVersion, Tf as CommandLane, Tu as runWithModelFallback, Tx as appendCronStyleCurrentTimeLine, Ua as getReplyFromConfig, Ud as resolveSystemRunApprovalRequestContext, Uu as writeRestartSentinel, Vb as loadModelCatalog, Vc as listDescendantRunsForRequester, Vl as resolveGatewaySessionStoreTarget, Vu as summarizeRestartSentinel, W_ as isTtsEnabled, Wa as buildBareSessionResetPrompt, Wd as resolveSystemRunApprovalRuntimeContext, Wu as normalizeHttpWebhookUrl, X_ as resolveTtsAutoMode, Xc as waitForActiveEmbeddedRuns, Xd as missingSystemRunApprovalBinding, Xg as buildHistoryContextFromEntries, Y_ as resolveTtsApiKey, Yc as getActiveEmbeddedRunCount, Yd as matchSystemRunApprovalBinding, Yl as lookupContextTokens, Yu as resolveDefaultCronStaggerMs, Z_ as resolveTtsConfig, Zc as waitForEmbeddedPiRunEnd, Zl as normalizeGroupActivation, Zu as normalizeOptionalAgentId, _C as archiveFileOnDisk, _c as updatePairedNodeMetadata, _d as clearSecretsRuntimeSnapshot, _f as enqueueCommandInLane, _i as createOutboundSendDeps, _o as createPluginRuntime, _u as resolveMessageChannelSelection, aS as resolveAgentAvatar, ac as getRemoteSkillEligibility, af as resolveHeartbeatReasonKind, ai as handleSlackHttpRequest, al as applyToolPolicyPipeline, av as setTtsProvider, bC as cleanupArchivedSessionTranscripts, bd as resolveCommandSecretsFromActiveRuntimeSnapshot, bf as getTotalQueueSize, bl as extractDeliveryInfo, cS as resolveEffectiveMessagesConfig, cc as refreshRemoteBinsForConnectedNodes, cl as resolveEffectiveToolPolicy, cu as buildOutboundSessionContext, cv as listSpeechProviders, dc as setSkillsRemoteRegistry, dh as clearAgentRunContext, dl as runBeforeToolCallHook, ed as normalizePayloadToSystemText, el as resolveBootstrapWarningSignaturesSeen, fc as approveNodePairing, fh as emitAgentEvent, fl as createOpenClawTools, fo as stopSubagentsForRequester, fu as normalizeReplyPayloadsForDelivery, gC as normalizeSessionDeliveryFields, gc as requestNodePairing, gd as activateSecretsRuntimeSnapshot, gf as clearBootstrapSnapshotOnSessionRollover, gi as resolveAgentOutboundTarget, gu as resetDirectoryCache, hC as mergeDeliveryContext, hc as renamePairedNode, hd as persistBrowserProxyFiles, hf as clearBootstrapSnapshot, hh as registerAgentRunContext, hi as resolveAgentDeliveryPlan, hu as maybeResolveIdLikeTarget, iS as resolveAgentOutboundIdentity, id as normalizeLegacyDeliveryInput, if as setHeartbeatsEnabled, il as resolveToolLoopDetectionConfig, im as readChannelAllowFromStoreSync, iu as parseTimeoutMsWithFallback, jC as resolveSessionResetPolicy, jS as resolveHeartbeatSenderContext, j_ as resolveAgentTimeoutMs, ju as isGatewaySigusr1RestartExternallyAllowed, k as pinActivePluginHttpRouteRegistry, kC as evaluateSessionFreshness, kS as resolveExecApprovalSessionTarget, k_ as resolveInputFileLimits, kc as resolveSessionAuthProfileOverride, kl as resolvePreferredSessionKeyForSessionIdMatches, ks as getTotalPendingReplies, ku as deferGatewayRestartUntilIdle, kv as getGlobalHookRunner, lC as updateSessionStore, lc as refreshRemoteNodeBins, lh as getMachineDisplayName, ll as resolveGroupToolPolicy, lr as resolveWhatsAppAccount, lu as deliverOutboundPayloads, lv as normalizeSpeechProviderId, mC as deliveryContextFromSession, mc as rejectNodePairing, md as applyBrowserProxyPaths, mh as onAgentEvent, mv as OPENAI_TTS_VOICES, nC as archiveRemovedSessionTranscripts, nf as requestHeartbeatNow, no as applyVerboseOverride, oc as primeRemoteSkillsCache, of as getPluginToolMeta, ol as buildDefaultToolPolicyPipelineSteps, ou as ensureOutboundSessionEntry, ov as textToSpeech, pc as listNodePairing, pd as closeTrackedBrowserTabsForSessions, ph as getAgentRunContext, pi as agentCommandFromIngress, pv as OPENAI_TTS_MODELS, qS as sleepWithAbort, qa as runCliAgent, qc as runEmbeddedPiAgent, qd as buildSystemRunApprovalBinding, qu as normalizeCronStaggerMs, rC as loadSessionStore, rd as parseAbsoluteTimeMs, rf as setHeartbeatWakeHandler, rg as isWithinDir, ro as parseVerboseOverride, rv as setTtsEnabled, ry as normalizePollInput, sC as saveSessionStore, sS as resolveAgentIdentity, sc as recordRemoteNodeInfo, sf as resolvePluginTools, sg as createReplyPrefixOptions, so as isAbortRequestText, su as resolveOutboundSessionRoute, td as normalizeRequiredName, tf as areHeartbeatsEnabled, tl as resolveFastModeState, uc as removeRemoteNodeInfo, ul as resolveSubagentToolPolicy, vC as archiveSessionTranscripts, vc as verifyNodeToken, vd as getActiveSecretsRuntimeSnapshot, vf as getActiveTaskCount, vi as createDefaultDeps, vl as normalizeSpawnedRunMetadata, vo as setGatewaySubagentRuntime, w as getChannelPlugin, wC as stripEnvelopeFromMessage, wS as getLastHeartbeatEvent, w_ as DEFAULT_INPUT_IMAGE_MIMES, wf as waitForActiveTasks, wn as formatThinkingLevels, ws as canonicalizePathVariant, xC as readSessionMessages, xS as requestBodyErrorToText, x_ as getAcpSessionManager, xf as markGatewayDraining, xl as parseSessionThreadInfo, y as resolveAgentSessionDirs, yC as capArrayByJsonBytes, yS as readJsonBodyWithLimit, yc as formatZonedTimestamp, yd as prepareSecretsRuntimeSnapshot, yf as getQueueSize, yi as createOutboundSendDeps$1, yl as resolveIngressWorkspaceOverrideForSpawnedRun, zC as saveCronStore, zS as resolveExecApprovalCommandDisplay, zc as initSubagentRegistry, zl as loadSessionEntry, zu as formatRestartSentinelMessage } from "./auth-profiles-Bc6TPi0n.js";
import { B as normalizeUsageDisplay, F as normalizeElevatedLevel, I as normalizeFastMode, O as DEFAULT_MODEL, R as normalizeReasoningLevel, V as normalizeVerboseLevel, f as resolveAllowedModelRef, g as resolveHooksGmailModel, h as resolveDefaultModelForAgent, i as getModelRefStatus, j as formatXHighModelHint, k as DEFAULT_PROVIDER, m as resolveConfiguredModelRef, o as isCliProvider, t as buildAllowedModelSet, u as normalizeModelSelection, x as resolveThinkingDefault, y as resolveSubagentConfiguredModelSelection, z as normalizeThinkLevel } from "./model-selection-DJOYg7Dx.js";
import { a as resolveAgentDir, f as resolveAgentSkillsFilter, i as resolveAgentConfig, m as resolveDefaultAgentId, n as listAgentEntries, p as resolveAgentWorkspaceDir, r as listAgentIds, u as resolveAgentModelFallbacksOverride, v as resolveSessionAgentId } from "./agent-scope-B-OyGztR.js";
import { S as parseAgentSessionKey, c as normalizeAgentId, h as toAgentStoreSessionKey, l as normalizeMainKey, m as toAgentRequestSessionKey, o as classifySessionKeyShape, r as buildAgentMainSessionKey, t as DEFAULT_AGENT_ID, u as resolveAgentIdFromSessionKey, v as isAcpSessionKey, x as isSubagentSessionKey, y as isCronRunSessionKey } from "./session-key-DyhRsRh-.js";
import { n as normalizeAccountId$1, r as normalizeOptionalAccountId, t as DEFAULT_ACCOUNT_ID } from "./account-id-O4Og6DrK.js";
import { t as matchesSkillFilter } from "./filter-BvhmwniI.js";
import { c as isNotFoundPathError, n as openBoundaryFile, r as openBoundaryFileSync } from "./boundary-file-read-Y1cMjPlu.js";
import { n as sameFileIdentity, t as openVerifiedFileSync } from "./safe-open-sync-BlMTEZMw.js";
import { a as logWarn, t as logDebug } from "./logger-iZtdpoh6.js";
import { n as runCommandWithTimeout, r as runExec } from "./exec-CwhzW0JB.js";
import { t as resolveOpenClawPackageRoot } from "./openclaw-root-0nFkqMDM.js";
import { _ as resolveWorkspaceTemplateDir, a as DEFAULT_IDENTITY_FILENAME, c as DEFAULT_SOUL_FILENAME, d as ensureAgentWorkspace, g as resolveDefaultAgentWorkspaceDir, i as DEFAULT_HEARTBEAT_FILENAME, l as DEFAULT_TOOLS_FILENAME, o as DEFAULT_MEMORY_ALT_FILENAME, p as isWorkspaceSetupCompleted, r as DEFAULT_BOOTSTRAP_FILENAME, s as DEFAULT_MEMORY_FILENAME, t as DEFAULT_AGENTS_FILENAME, u as DEFAULT_USER_FILENAME } from "./workspace-Dns6NMt3.js";
import { Cn as resolveSubagentMaxConcurrent, J as AVATAR_MAX_BYTES, Qt as ensureControlUiAllowedOriginsForNonLoopbackBind, Sn as resolveAgentMaxConcurrent, X as isAvatarHttpUrl, Xt as applyMergePatch, Z as isAvatarImageDataUrl, Zt as applyLegacyMigrations, b as validateConfigObjectWithPlugins, c as parseConfigJson5, d as readConfigFileSnapshot, f as readConfigFileSnapshotForWrite, g as writeConfigFile, i as createConfigIO, it as applyConfigOverrides, p as resolveConfigSnapshotHash, pn as buildTalkConfigResponse, q as parseByteSize, s as loadConfig, tt as looksLikeAvatarPath, u as readBestEffortConfig, x as OpenClawSchema } from "./io-CezuVcrG.js";
import "./host-env-security-DnH8wzZ4.js";
import "./safe-text-BcUvBreN.js";
import { n as VERSION, o as resolveRuntimeServiceVersion } from "./version-BMIQmWNJ.js";
import { a as hasConfiguredSecretInput } from "./types.secrets-DuSPmmWB.js";
import "./env-substitution--sbeMYae.js";
import { n as isTestDefaultMemorySlotDisabled } from "./config-state-sYURQqD8.js";
import "./network-mode-nTYy2WxO.js";
import { l as CHANNEL_IDS } from "./registry-jBzBWMf6.js";
...
import { r as migrateLegacyConfig } from "./config-CcaRAPg3.js";
import { r as isPidAlive } from "./process-scoped-map-C7rag2cs.js";
import "./audit-fs-Cequ8jTw.js";
import "./resolve-D7R3Obgc.js";
import { C as isExternalHookSession, G as estimateBase64DecodedBytes, J as fetchWithSsrFGuard, O as ToolInputError, Q as normalizeSecretInput, S as getHookType, b as buildSafeExternalPrompt, x as detectSuspiciousPatterns } from "./provider-web-search-DqPBRERs.js";
import "./text-runtime-Cv7IlZFR.js";
import { $ as listCoreToolSections, K as mergeAlsoAllowPolicy, P as cleanStaleLockFiles, W as collectExplicitAllowlist, X as resolveToolProfilePolicy, Z as PROFILE_OPTIONS, et as resolveCoreToolProfiles, s as isRestartEnabled, t as listAgentWorkspaceDirs } from "./workspace-dirs-B6rDmzuU.js";
import { C as enableTailscaleServe, S as enableTailscaleFunnel, T as getTailnetHostname, _ as AUTH_RATE_LIMIT_SCOPE_SHARED_SECRET, b as disableTailscaleFunnel, d as authorizeHttpGatewayConnect, f as authorizeWsControlUiGatewayConnect, g as AUTH_RATE_LIMIT_SCOPE_HOOK_AUTH, h as AUTH_RATE_LIMIT_SCOPE_DEVICE_TOKEN, m as resolveGatewayAuth, p as isLocalDirectRequest, u as assertGatewayAuthConfigured, v as createAuthRateLimiter, x as disableTailscaleServe, y as normalizeRateLimitClientIp } from "./config-SJMQwqYd.js";
import { t as formatCliCommand } from "./command-format-C8aJknFW.js";
import { t as safeEqualSecret } from "./secret-equal-BH8cCC3g.js";
import { n as pickPrimaryTailnetIPv4, r as pickPrimaryTailnetIPv6 } from "./tailnet-KyAU6tj_.js";
import { a as isTrustedProxyAddress, c as pickPrimaryLanIPv4, d as resolveGatewayListenHosts, f as resolveRequestClientIp, l as resolveClientIp, n as isLoopbackAddress, o as isValidIPv4, r as isLoopbackHost, s as normalizeHostHeader, t as isLocalishHost, u as resolveGatewayBindHost } from "./net-B_Iq_SVP.js";
import { d as readGatewayTokenEnv, u as readGatewayPasswordEnv } from "./credentials-B7GJXbww.js";
import { A as cleanOldMedia, _ as startBrowserControlServiceFromConfig, g as createBrowserControlContext, h as createBrowserRouteDispatcher, it as resolveConfiguredSecretInputString, nt as mergeGatewayAuthConfig, rt as mergeGatewayTailscaleConfig, tt as ensureGatewayStartupAuth, x as movePathToTrash } from "./routes-AlbnCYWi.js";
import { f as hasBinary } from "./frontmatter-BGJSb9Mh.js";
import "./env-overrides-SSye1Eey.js";
import { n as assertNoPathAliasEscape } from "./path-alias-guards-B3ZKrId1.js";
import { o as loadWorkspaceSkillEntries, r as buildWorkspaceSkillSnapshot } from "./skills-D8mkwPU_.js";
import { n as readJsonFile, r as writeJsonAtomic, t as createAsyncLock } from "./json-files-BhLX9wE7.js";
import { a as inspectPortUsage, c as formatPortDiagnostics } from "./ports-D_2Jwnkx.js";
import "./ports-lsof-DiY6GaAf.js";
import "./ssh-tunnel-DFSJj-3E.js";
import { u as SsrFBlockedError } from "./image-ops-DM56IRtp.js";
import { a as openFileWithinRoot, c as readLocalFileSafely, f as writeFileWithinRoot, t as SafeOpenError } from "./fs-safe-Ds1qsPxW.js";
...
import { _ as GATEWAY_CLIENT_MODES, b as normalizeGatewayClientMode, f as normalizeMessageChannel, g as GATEWAY_CLIENT_IDS, h as GATEWAY_CLIENT_CAPS, i as isGatewayMessageChannel, n as isDeliverableMessageChannel, r as isGatewayCliClient, s as isWebchatClient, t as INTERNAL_MESSAGE_CHANNEL, v as GATEWAY_CLIENT_NAMES, y as hasGatewayClientCap } from "./message-channel-C4icaB2h.js";
import { o as buildChannelAccountBindings } from "./resolve-route-CUHslQlg.js";
import { d as triggerInternalHook, n as createInternalHookEvent, t as clearInternalHooks, u as registerInternalHook } from "./internal-hooks-CWvLyTiW.js";
import { C as peekSystemEventEntries, F as setSessionRuntimeModel, S as isSystemEventContextChanged, b as enqueueSystemEvent, c as stripHeartbeatToken, d as resolveExplicitAgentSessionKey, f as resolveMainSessionKey, g as isSilentReplyText, j as mergeSessionEntry, l as canonicalizeMainSessionAlias, m as SILENT_REPLY_TOKEN, o as isHeartbeatContentEffectivelyEmpty, p as HEARTBEAT_TOKEN, s as resolveHeartbeatPrompt$1, u as resolveAgentMainSessionKey } from "./lazy-runtime-07jXxTa3.js";
import "./config-schema-GQ6uWjXe.js";
import { t as resolveAccountEntry } from "./account-lookup-CbUrO7xh.js";
import { $ as validateExecApprovalsNodeSetParams, $t as buildDeviceAuthPayloadV3, A as validateConfigPatchParams, At as validateSessionsUsageParams, B as validateCronRunsParams, Bt as validateWebLoginStartParams, C as validateChannelsStatusParams, Ct as validateSessionsCompactParams, D as validateChatSendParams, Dt as validateSessionsPreviewParams, E as validateChatInjectParams, Et as validateSessionsPatchParams, F as validateConnectParams, Ft as validateTalkConfigParams, G as validateDevicePairRejectParams, Gt as validateWizardStatusParams, H as validateCronUpdateParams, Ht as validateWizardCancelParams, I as validateCronAddParams, It as validateTalkModeParams, J as validateDeviceTokenRotateParams, Jt as parseSessionLabel, K as validateDevicePairRemoveParams, Kt as ErrorCodes, L as validateCronListParams, Lt as validateToolsCatalogParams, M as validateConfigSchemaLookupResult, Mt as validateSkillsInstallParams, N as validateConfigSchemaParams, Nt as validateSkillsStatusParams, O as validateConfigApplyParams, Ot as validateSessionsResetParams, P as validateConfigSetParams, Pt as validateSkillsUpdateParams, Q as validateExecApprovalsNodeGetParams, Qt as buildDeviceAuthPayload, R as validateCronRemoveParams, Rt as validateUpdateRunParams, S as validateChannelsLogoutParams, St as validateSendParams, T as validateChatHistoryParams, Tt as validateSessionsListParams, U as validateDevicePairApproveParams, Ut as validateWizardNextParams, V as validateCronStatusParams, Vt as validateWebLoginWaitParams, W as validateDevicePairListParams, Wt as validateWizardStartParams, X as validateExecApprovalResolveParams, Xt as resolveAuthConnectErrorDetailCode, Y as validateExecApprovalRequestParams, Yt as ConnectErrorDetailCodes, Z as validateExecApprovalsGetParams, Zt as resolveDeviceAuthConnectErrorDetailCode, _ as validateAgentsFilesGetParams, _t as validatePollParams, at as validateNodeInvokeParams, b as validateAgentsListParams, bt as validateSecretsResolveParams, c as isNodeRoleMethod, ct as validateNodePairApproveParams, d as formatValidationErrors, dt as validateNodePairRequestParams, et as validateExecApprovalsSetParams, f as validateAgentIdentityParams, ft as validateNodePairVerifyParams, g as validateAgentsDeleteParams, gt as validateNodeRenameParams, h as validateAgentsCreateParams, ht as validateNodePendingEnqueueParams, i as PAIRING_SCOPE$1, in as publicKeyRawBase64UrlFromPem, it as validateNodeEventParams, j as validateConfigSchemaLookupParams, jt as validateSkillsBinsParams, k as validateConfigGetParams, kt as validateSessionsResolveParams, ln as normalizeInputProvenance, lt as validateNodePairListParams, m as validateAgentWaitParams, mt as validateNodePendingDrainParams, n as APPROVALS_SCOPE$1, nn as loadOrCreateDeviceIdentity, nt as validateModelsListParams, o as WRITE_SCOPE, on as verifyDeviceSignature, ot as validateNodeInvokeResultParams, p as validateAgentParams, pt as validateNodePendingAckParams, q as validateDeviceTokenRevokeParams, qt as errorShape, rn as normalizeDevicePublicKeyBase64Url, rt as validateNodeDescribeParams, s as authorizeOperatorScopesForMethod, st as validateNodeListParams, t as ADMIN_SCOPE$3, tn as deriveDeviceIdFromPublicKey, tt as validateLogsTailParams, ut as validateNodePairRejectParams, v as validateAgentsFilesListParams, vt as validatePushTestParams, w as validateChatAbortParams, wt as validateSessionsDeleteParams, x as validateAgentsUpdateParams, xt as validateSecretsResolveResult, y as validateAgentsFilesSetParams, yt as validateRequestFrame, z as validateCronRunParams, zt as validateWakeParams } from "./method-scopes-BAswg77K.js";
import { a as loadSessionUsageTimeSeries, c as formatUsd, d as deriveSessionTotalTokens, f as hasNonzeroUsage, n as loadCostUsageSummary, r as loadSessionCostSummary, s as formatTokenCount, t as discoverAllSessions } from "./session-cost-usage-C3_3zEKV.js";
import { a as resolveSessionTranscriptPath, c as resolveSessionTranscriptsDirForAgent, i as resolveSessionFilePathOptions, l as resolveStorePath, r as resolveSessionFilePath } from "./paths-BumENdHQ.js";
import "./routing-3o2D0ix4.js";
import { v as getChannelActivity } from "./send-TDX_qI_x.js";
import { n as isDiagnosticsEnabled } from "./diagnostic-events-zPbQiklC.js";
import { a as DEFAULT_EXEC_APPROVAL_TIMEOUT_MS, f as normalizeExecApprovals, g as readExecApprovalsSnapshot, s as ensureExecApprovals, u as mergeExecApprovalsSocketDefaults, w as saveExecApprovals } from "./node-resolve-DiVPimcG.js";
...
import { _ as startDiagnosticHeartbeat, v as stopDiagnosticHeartbeat } from "./diagnostic-D8TBqX9f.js";
import "./message-hook-mappers-MHm61O7_.js";
import "./json-store-Ct34wStR.js";
import { n as callGateway, u as loadGatewayTlsRuntime$1 } from "./call-x5WvUEsz.js";
import { n as normalizeDeviceAuthScopes } from "./device-auth-Do04Bx9k.js";
...
import { n as getMemorySearchManager, r as resolveMemoryBackendConfig } from "./search-manager-ByZ9OOyz.js";
import "./core-TgQ7U3Ou.js";
import { n as formatConfigIssueLines } from "./issue-format-i6sEuV4a.js";
import "./logging-imcVaYUC.js";
import "./note-aKR6kEr4.js";
import "./state-paths-C7dX__ql.js";
import "./config-value-Cb6kcdav.js";
import { f as isKnownSecretTargetId } from "./command-secret-targets-Ow94fQb1.js";
import "./brave-wyq_csg5.js";
import "./provider-usage-La8jvEfN.js";
import "./perplexity-Cjiwa0zB.js";
import { t as cleanStaleGatewayProcessesSync } from "./restart-stale-pids-OWmDUCi0.js";
...
import { n as withProgress } from "./progress-B4roBB_B.js";
...
import { i as resolveAssistantAvatarUrl, n as buildControlUiAvatarUrl, r as normalizeControlUiBasePath, t as CONTROL_UI_AVATAR_PREFIX } from "./control-ui-shared-CfOOBRJE.js";
import { c as handleReset } from "./onboard-helpers-vGwtm3SO.js";
import "./runtime-parse-PVcg8TyI.js";
import { p as scheduleDetachedLaunchdRestartHandoff } from "./launchd-5_vi_uEh.js";
import { c as parseProcCmdline, s as isGatewayArgv } from "./service-KUbBlQEC.js";
import "./systemd-D9tFr0-S.js";
import "./shared-dVhgMMNI.js";
import "./systemd-hints-CfA12Ack.js";
import { t as parsePort } from "./parse-port-BZ2l6YzE.js";
import { n as addGatewayServiceCommands } from "./daemon-cli-D4CC_IwJ.js";
import { t as probeGateway } from "./probe-CvVFHDON.js";
import "./lifecycle-core-83GpB7V7.js";
import "./status-CO9RwSKS.js";
import "./diagnostics-B0pY3AcB.js";
import "./inspect-DSc4PckQ.js";
import "./probe-auth-D0yTXyIH.js";
import { t as WizardCancelledError } from "./prompts-DHs_x86z.js";
import { a as rejectDevicePairing, c as revokeDeviceToken, d as updatePairedDeviceMetadata, f as verifyDeviceToken, i as listDevicePairing, l as rotateDeviceToken, m as roleScopesAllow, n as ensureDeviceToken, o as removePairedDevice, p as resolveMissingRequestedScope, r as getPairedDevice, s as requestDevicePairing, t as approveDevicePairing, u as summarizeDeviceTokens } from "./device-pairing-CqgFQmgu.js";
import { n as verifyDeviceBootstrapToken } from "./device-bootstrap--vTI8MmG.js";
import "./agent-CkWPHX7Y.js";
import { n as resolveHookConfig, r as shouldIncludeHook } from "./config-BAI3gK1l.js";
import { t as buildWorkspaceSkillStatus } from "./skills-status-DR3A1KMJ.js";
import { t as ensureOpenClawCliOnPath } from "./path-env-B-B47KLG.js";
import { n as DEFAULT_GATEWAY_HTTP_TOOL_DENY } from "./dangerous-tools-XPcXSNn3.js";
import { t as readSecretFromFile } from "./secret-file-DyQ7W6e7.js";
import { r as resolveConfiguredDeferredChannelPluginIds } from "./channel-plugin-ids-odAH8XWC.js";
import { a as buildBaseHints, i as applySensitiveHints, n as redactConfigSnapshot, o as mapSensitivePaths, r as restoreRedactedValues, s as applyDerivedTags, t as redactConfigObject } from "./redact-snapshot-DAHiDTMK.js";
import "./table-B8SbFA2P.js";
import { n as resolveWideAreaDiscoveryDomain, r as writeWideAreaGatewayZone } from "./widearea-dns-D-0k_ew2.js";
import { i as toOptionString, n as extractGatewayMiskeys, r as maybeExplainGatewayServiceStop, t as describeUnknownError } from "./shared-Dw8M1-fb.js";
import { t as discoverGatewayBeacons } from "./bonjour-discovery-DhDhOGgb.js";
import { h as pickGatewaySelfPresence, t as getStatusSummary } from "./status.summary-DGkrV6Gu.js";
import { n as resolveHeartbeatIntervalMs, t as isHeartbeatEnabledForAgent } from "./heartbeat-summary-Ds9eeKGN.js";
import { i as styleHealthChannelLine, n as getHealthSnapshot, t as formatHealthChannelLines } from "./health-C8SZ7cuw.js";
import { a as resolveControlUiRootOverrideSync, n as isPackageProvenControlUiRootSync, o as resolveControlUiRootSync, t as ensureControlUiAssetsBuilt } from "./control-ui-assets-CAky_mgS.js";
import { a as resolveNpmChannelTag, n as compareSemverStrings, p as normalizeUpdateChannel, t as checkUpdateStatus } from "./update-check-BnBXzhKb.js";
import "./setup.secret-input-C884i-5V.js";
import { t as runSetupWizard } from "./setup-BMQ5YSTC.js";
import { a as resolveApnsAuthConfigFromEnv, c as shouldClearStoredApnsRegistration, d as parseMessageWithAttachments, f as formatForLog, g as setGatewayWsLogStyle, h as summarizeAgentEventForWsLog, l as resolveApnsRelayConfigFromEnv, m as shouldLogWs, n as loadApnsRegistration, o as sendApnsAlert, p as logWs, r as normalizeApnsEnvironment, s as sendApnsBackgroundWake, t as clearApnsRegistrationIfCurrent, u as normalizeRpcAttachmentsToChatAttachments } from "./push-apns-BqpyRXzH.js";
import { _ as buildGogWatchStartArgs, g as buildGogWatchServeArgs, i as ensureTailscaleEndpoint, w as resolveGmailHookRuntimeConfig } from "./gmail-setup-utils-CQBUYGHy.js";
import { g as computePreviousRunAtMs, h as computeNextRunAtMs, m as coerceFiniteScheduleNumber, p as normalizeStoredCronJobs, t as runGatewayUpdate } from "./update-runner-m7qOwuqA.js";
import { i as loadAgentIdentity, o as pruneAgentConfig, r as findAgentEntryIndex, t as applyAgentConfig } from "./agents.config-DWIIfo93.js";
import { n as isNodeCommandAllowed, r as resolveNodeCommandAllowlist } from "./node-command-policy-DVwDvxCy.js";
import { t as buildChannelAccountSnapshot } from "./status-CECKgKm2.js";
import "./status-BrwtTLb1.js";
import "./node-service-CZeL9wna.js";
import "./channels-status-issues-Stv_zyuM.js";
import "./channels-OZMO7L2m.js";
import "./status.update-CzKpRFgc.js";
import "./skill-scanner-BiRgMrKx.js";
import { t as installSkill } from "./skills-install-Dih4so-b.js";
import { t as resolveAllowedAgentIds } from "./hooks-policy-Bjwkmif6.js";
import { t as collectEnabledInsecureOrDangerousFlags } from "./dangerous-config-flags-B8uL4Utz.js";
import { t as loadWorkspaceHookEntries } from "./workspace-CTNORbXY.js";
import { n as forceFreePortAndWait, r as waitForPortBindable } from "./ports-sEJV3QdT.js";
...
function loadSshConfigModule() {
	sshConfigModulePromise ??= import("./ssh-config-Bym0Cwdz.js");
	return sshConfigModulePromise;
}
function loadSshTunnelModule() {
	sshTunnelModulePromise ??= import("./ssh-tunnel-UfJ7WKXn.js");
...
async function gatewayStatusCommand(opts, runtime) {
	...
	const { discovery, probed } = await withProgress({
		...
		if (!sshTarget && opts.sshAuto) {
			...
			const validCandidates = candidates.filter((candidate) => Boolean(parseSshTarget(candidate)));
			if (validCandidates.length > 0) sshTarget = validCandidates[0] ?? null;
		}
...
async function resolveSshTarget(rawTarget, identity, overallTimeoutMs) {
	const [{ resolveSshConfig }, { parseSshTarget }] = await Promise.all([loadSshConfigModule(), loadSshTunnelModule()]);
...
function shouldSkipForwardingFallback(params) {
	...
	return (getChannelPlugin(channel)?.execApprovals)?.shouldSuppressForwardingFallback?.({
		cfg: params.cfg,
...
function buildRequestPayloadForTarget(cfg, request, nowMsValue, target) {
	const channel = normalizeMessageChannel(target.channel) ?? target.channel;
	const pluginPayload = channel ? getChannelPlugin(channel)?.execApprovals?.buildPendingPayload?.({
		cfg,
		request,
		target,
		nowMs: nowMsValue
...
function buildResolvedPayloadForTarget(cfg, resolved, target) {
	const channel = normalizeMessageChannel(target.channel) ?? target.channel;
	const pluginPayload = channel ? getChannelPlugin(channel)?.execApprovals?.buildResolvedPayload?.({
		cfg,
		resolved,
		target
	}) : null;
...
function createExecApprovalForwarder(deps = {}) {
	...
	const handleRequested = async (request) => {
		...
		deliverToTargets({
			...
			log$6.error(`exec approvals: failed to deliver request ${request.id}: ${String(err)}`);
		});
		return true;
	};
...
const log$5 = createSubsystemLogger("gateway/heartbeat");
...
function resolveHeartbeatAckMaxChars$2(cfg, heartbeat) {
...
async function pruneHeartbeatTranscript(params) {
	...
	try {
		if ((await fs$1.stat(transcriptPath)).size > preHeartbeatSize) await fs$1.truncate(transcriptPath, preHeartbeatSize);
	} catch {}
}
/**
...
async function captureTranscriptState(params) {
	...
	try {
		...
		return {
			transcriptPath,
			preHeartbeatSize: (await fs$1.stat(transcriptPath)).size
		};
	} catch {
		return {};
	}
...
async function resolveHeartbeatPreflight(params) {
	...
	try {
		if (isHeartbeatContentEffectivelyEmpty(await fs$1.readFile(heartbeatFilePath, "utf-8"))) return {
			...basePreflight,
...
async function runHeartbeatOnce(opts) {
	...
	if (delivery.reason === "unknown-account") log$5.warn("heartbeat: unknown accountId", {
		accountId: delivery.accountId ?? heartbeatAccountId ?? null,
		target: heartbeat?.target ?? "none"
	});
	else if (heartbeatAccountId) log$5.info("heartbeat: using explicit accountId", {
	...
	try {
		...
		const normalized = normalizeHeartbeatReply(replyPayload, responsePrefix, resolveHeartbeatAckMaxChars$2(cfg, heartbeat));
		...
		if (heartbeatPlugin?.heartbeat?.checkReady) {
			...
			if (!readiness.ok) {
				...
				log$5.info("heartbeat: channel not ready", {
					channel: delivery.channel,
					reason: readiness.reason
				});
				return {
		...
		log$5.error(`heartbeat failed: ${reason}`, { error: reason });
		return {
			status: "failed",
			reason
		};
...
function startHeartbeatRunner(opts) {
	...
	const updateConfig = (cfg) => {
		...
		if (!initialized) {
			if (!nextEnabled) log$5.info("heartbeat: disabled", { enabled: false });
			else log$5.info("heartbeat: started", { intervalMs: Math.min(...intervals) });
			initialized = true;
		} else if (prevEnabled !== nextEnabled) if (!nextEnabled) log$5.info("heartbeat: disabled", { enabled: false });
		else log$5.info("heartbeat: started", { intervalMs: Math.min(...intervals) });
		scheduleNext();
	};
	const run = async (params) => {
		...
		if (requestedSessionKey || requestedAgentId) {
			...
			try {
				...
				log$5.error(`heartbeat runner: targeted runOnce threw unexpectedly: ${errMsg}`, { error: errMsg });
		...
		for (const agent of state.agents.values()) {
			...
			try {
				...
				const errMsg = formatErrorMessage(err);
				log$5.error(`heartbeat runner: runOnce threw unexpectedly: ${errMsg}`, { error: errMsg });
...
function createChannelManager(opts) {
	...
	const resolveAccountHealthMonitorOverride = (channelConfig, accountId) => {
		...
		const matchKey = Object.keys(channelConfig.accounts).find((key) => normalizeAccountId$1(key) === normalizedAccountId);
		if (!matchKey) return;
...
function applyJobPatch(job, patch, opts) {
	...
	if (!patch.delivery && patch.payload?.kind === "agentTurn") {
		...
		const isIsolatedLike = job.sessionTarget === "isolated" || job.sessionTarget === "current" || job.sessionTarget.startsWith("session:");
		if (legacyDeliveryPatch && isIsolatedLike && job.payload.kind === "agentTurn") job.delivery = mergeCronDelivery(job.delivery, legacyDeliveryPatch);
	}
...
function ignoreCiaoCancellationRejection(reason) {
	...
	if (!CIAO_CANCELLATION_MESSAGE_RE.test(message)) return false;
...
async function startGatewayBonjourAdvertiser(opts) {
	...
	function createCycle() {
		...
		return {
			responder,
			services,
			cleanupUnhandledRejection: services.length > 0 ? registerUnhandledRejectionHandler(ignoreCiaoCancellationRejection) : void 0
		};
	}
...
let cachedChannelRuntime$1;
function getChannelRuntime$1() {
	cachedChannelRuntime$1 ??= createPluginRuntime().channel;
	return cachedChannelRuntime$1;
}
...
async function emitSessionUnboundLifecycleEvent(params) {
	...
	getChannelRuntime$1().discord.threadBindings.unbindBySessionKey({
		...
		try {
			...
			const dispatcher = createReplyDispatcher({
				...
				deliver: async (payload, info) => {
					if (info.kind !== "block" && info.kind !== "final") return;
			...
			dispatchInboundMessage({
				...
				if (!agentRunStarted) {
					...
					if (btwReplies.length > 0 && btwText) {
						...
						const combinedReply = deliveredReplies.filter((entry) => entry.kind === "final").map((entry) => entry.payload).map((part) => part.text?.trim() ?? "").filter(Boolean).join("\n\n").trim();
						let message;
						if (combinedReply) {
...
const cronHandlers = {
	...
	"cron.add": async ({ params, respond, context }) => {
		const normalized = normalizeCronJobCreate(params, { sessionContext: { sessionKey: typeof params?.sessionKey === "string" ? params.sessionKey : void 0 } }) ?? params;
...
const nodeHandlers = {
	...
	"node.event": async ({ params, respond, context, client }) => {
		...
		await respondUnavailableOnThrow(respond, async () => {
			const { handleNodeEvent } = await import("./server-node-events-BUkyyaXy.js");
...
const ttsHandlers = {
	...
	"tts.setProvider": async ({ params, respond }) => {
		const provider = normalizeSpeechProviderId(typeof params.provider === "string" ? params.provider.trim() : "");
		const cfg = loadConfig();
		const knownProviders = new Set(listSpeechProviders(cfg).map((entry) => entry.id));
		if (!provider || !knownProviders.has(provider)) {
			respond(false, void 0, errorShape(ErrorCodes.INVALID_REQUEST, "Invalid provider. Use a registered TTS provider id such as openai, elevenlabs, or microsoft."));
			return;
		}
		try {
		...
		try {
			...
			respond(true, {
				providers: listSpeechProviders(cfg).map((provider) => ({
					...
					models: provider.id === "openai" && provider.models == null ? [...OPENAI_TTS_MODELS] : [...provider.models ?? []],
					voices: provider.id === "openai" && provider.voices == null ? [...OPENAI_TTS_VOICES] : [...provider.voices ?? []]
				})),
...
const usageHandlers = {
	...
	"sessions.usage.logs": async ({ respond, params }) => {
		...
		if (!resolved) return;
		const { config, entry, agentId, sessionId, sessionFile } = resolved;
		const { loadSessionLogs } = await import("./session-cost-usage-gY6ycpgI.js");
...
function loadGatewayPlugins(params) {
	...
	if ((params.logDiagnostics ?? true) && pluginRegistry.diagnostics.length > 0) for (const diag of pluginRegistry.diagnostics) {
...
async function startBrowserControlServerIfEnabled() {
	...
	const mod = override ? await import(override) : await import("./server-BkoSC0aM.js");
	...
	const applyHotReload = async (plan, nextConfig) => {
		...
		if (plan.restartHealthMonitor) {
			...
			nextState.channelHealthMonitor = minutes === 0 ? null : params.createHealthMonitor({
				checkIntervalMs: (minutes ?? 5) * 6e4,
				...staleMinutes != null && { staleEventThresholdMs: staleMinutes * 6e4 },
				...nextConfig.gateway?.channelMaxRestartsPerHour != null && { maxRestartsPerHour: nextConfig.gateway.channelMaxRestartsPerHour }
			});
		}
...
async function startPluginServices(params) {
	...
	for (const entry of params.registry.services) {
		...
		try {
			...
			log$1.error(`plugin service failed (${service.id}, plugin=${entry.pluginId}, root=${entry.rootDir ?? "unknown"}): ${error?.message ?? String(err)}${stack ? `\n${stack}` : ""}`);
		}
	}
	return { stop: async () => {
...
async function prepareGatewayStartupConfig(params) {
	...
	const startupPreflightConfig = applyGatewayAuthOverridesForStartupPreflight(params.runtimeConfig, {
...
async function startGatewayServer(port = 18789, opts = {}) {
	...
	const deferredConfiguredChannelPluginIds = minimalTestGateway ? [] : resolveConfiguredDeferredChannelPluginIds({
		config: cfgAtStart,
	...
	if (!minimalTestGateway) ({pluginRegistry, gatewayMethods: baseGatewayMethods} = loadGatewayPlugins({
		cfg: cfgAtStart,
		workspaceDir: defaultWorkspaceDir,
		log,
		coreGatewayHandlers,
	...
	const { canvasHost, releasePluginRouteRegistry, httpServer, httpServers, httpBindHosts, wss, clients, broadcast, broadcastToConnIds, agentRunSeq, dedupe, chatRunState, chatRunBuffers, chatDeltaSentAt, addChatRun, removeChatRun, chatAbortControllers, toolEventRecipients } = await createGatewayRuntimeState({
		cfg: cfgAtStart,
		bindHost,
		port,
		controlUiEnabled,
	...
	let channelHealthMonitor = healthCheckDisabled ? null : startChannelHealthMonitor({
		channelManager,
	...
	if (!minimalTestGateway) (async () => {
		const { recoverPendingDeliveries } = await import("./delivery-queue-BngeTTrV.js");
		const { deliverOutboundPayloads } = await import("./deliver-Bo4aVJNz.js");
	...
	let browserControl = null;
	if (!minimalTestGateway) {
		if (deferredConfiguredChannelPluginIds.length > 0) ({pluginRegistry} = loadGatewayPlugins({
			cfg: cfgAtStart,
			workspaceDir: defaultWorkspaceDir,
			log,
			coreGatewayHandlers,
	...
	const configReloader = minimalTestGateway ? { stop: async () => {} } : (() => {
		const { applyHotReload, requestGatewayRestart } = createGatewayReloadHandlers({
			...
			logCron,
			logReload,
			createHealthMonitor: (opts) => startChannelHealthMonitor({
				channelManager,
				checkIntervalMs: opts.checkIntervalMs,
				...opts.staleEventThresholdMs != null && { staleEventThresholdMs: opts.staleEventThresholdMs },
				...opts.maxRestartsPerHour != null && { maxRestartsPerHour: opts.maxRestartsPerHour }
			})
		});
