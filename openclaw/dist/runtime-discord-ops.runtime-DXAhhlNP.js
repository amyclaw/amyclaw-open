...
import { _ as resolveStateDir, x as resolveRequiredHomeDir } from "./paths-1qR_mW4i.js";
import "./tmp-openclaw-dir-BDQ0wJ2G.js";
import "./theme-BSXzMzAA.js";
import { a as logVerbose, d as warn, l as shouldLogVerbose, r as isVerbose, t as danger } from "./globals-DqZvRoPX.js";
import { p as createNonExitingRuntime, t as createSubsystemLogger } from "./subsystem-MGyxt_Bl.js";
import "./ansi-BPhP6LBZ.js";
import "./boolean-D8Ha5nYV.js";
import "./env-DlREndPb.js";
import "./warning-filter-Cg8_xqcp.js";
import { E as truncateUtf16Safe } from "./utils-BMtC0Ocd.js";
import "./links-DA9sitJV.js";
import { w as withFileLock } from "./setup-binary-nB5GxsnS.js";
import { $ as listDiscordDirectoryPeersLive, $S as normalizeDiscordToken, $i as resolveDiscordComponentEntry, $o as createNoopThreadBindingManager, $t as createChannelInboundDebouncer, $w as formatAllowlistMatchMeta, A_ as finalizeInboundContext, Ai as unregisterGateway, As as dispatchReplyWithBufferedBlockDispatcher, At as buildMediaPayload, Cn as shouldHandleTextCommands, DS as resolveFetch, Di as setPresence, Es as recordInboundSession, Fa as dispatchInboundMessage, Fd as resolvePinnedMainDmOwnerFromAllowlist, Fi as normalizeDiscordListenerTimeoutMs, Fs as formatInboundEnvelope, Gi as sendDiscordComponentMessage, Hg as logAckFailure, Hw as resolveCommandAuthorizedFromAuthorizers, Id as buildUntrustedChannelMetadata, Ii as runDiscordTaskWithTimeout, Ji as parseDiscordComponentCustomId, Jt as createStatusReactionController, Jv as resolvePluginConversationBindingApproval, K as matchPluginCommand, Ki as createDiscordFormModal, Kt as DEFAULT_TIMING, Kv as parsePluginBindingApprovalCustomId, LS as getExecApprovalApproverDmNoticeText, Lw as createFinalizableDraftLifecycle, Ma as chunkDiscordTextWithMode, Na as createReplyReferencePlanner, Nd as resolveDmGroupAccessWithLists, Nt as createArmableStallWatchdog, OS as wrapFetchWithAbortSignal, Oa as sendDiscordText, Oh as issuePairingChallenge, Os as createReplyDispatcherWithTyping, Pi as normalizeDiscordInboundWorkerTimeoutMs, Q as listDiscordDirectoryGroupsLive, QS as resolveDiscordMaxLinesPerMessage, Qg as buildPendingHistoryContextFromMap, Qt as resolveNativeCommandSessionTargets, Rb as EmbeddedBlockChunker, Ri as auditDiscordChannelPermissions, Rn as dispatchPluginInteractiveHandler, Rs as resolveEnvelopeFormatOptions, Rv as buildPluginBindingResolvedText, Sl as formatThreadBindingDurationLabel, Sn as serializeCommandArgs, U as executePluginCommand, Ug as logInboundDrop, Ui as removeReactionDiscord, Us as buildModelsProviderData, Uw as resolveControlCommandGate, VC as resolveMarkdownTableMode, Vi as reactMessageDiscord, W as getPluginCommandSpecs, Wg as logTypingFailure, Wi as sendTypingDiscord, Wv as isPluginOwnedSessionBindingRecord, Wy as loadWebMedia, Xi as parseDiscordModalCustomId, Yi as parseDiscordComponentCustomIdForCarbon, ZS as resolveDiscordAccount, Za as resolveStoredModelOverride, Zi as parseDiscordModalCustomIdForCarbon, Zo as reconcileAcpThreadBindingsOnStartup, Zt as createRunStateMachine, Zv as getSessionBindingService, a as clearExpiredCooldowns, aS as resolveAgentAvatar, aT as buildAllowlistResolutionSummary, a_ as buildMentionRegexes, aa as sendWebhookMessageDiscord, ag as createTypingCallbacks, at as resolveDiscordGuildEntry, bn as resolveCommandArgMenu, bs as resolveMentionGatingWithBypass, cT as patchAllowlistUsersInConfigEntries, cs as pinMessageDiscord, ct as resolveDiscordOwnerAllowFrom, ds as unpinMessageDiscord, dt as shouldEmitDiscordReactionNotification, e_ as clearHistoryEntriesIfEnabled, ea as resolveDiscordModalEntry, en as shouldDebounceTextInbound, es as createThreadBindingManager, et as isDiscordGroupAllowedByPolicy, f as resolveProfilesUnavailableReason, fm as ensureConfiguredAcpRouteReady, fn as listChatCommands, fs as createDiscordClient, ft as formatDiscordReactionEmoji, g_ as resolveThreadBindingMaxAgeMs, hn as listNativeCommandSpecsForConfig, ht as resolveTimestampMs, iC as readSessionUpdatedAt, iT as addAllowlistUserEntriesFromConfigEntry, ia as sendVoiceMessageDiscord, is as editMessageDiscord, it as resolveDiscordChannelConfigWithFallback, js as dispatchReplyWithDispatcher, ka as stripUndefinedFields, kd as readStoreAllowFromForDmPolicy, kh as buildPairingReply, ki as registerGateway, lC as updateSessionStore, lS as resolveHumanDelayConfig, lm as upsertChannelPairingRequest, lt as resolveDiscordShouldRequireMention, m_ as resolveThreadBindingIdleTimeoutMs, mt as resolveDiscordSystemLocation, na as sendPollDiscord, nc as listSkillCommandsForAgents, ns as createThreadDiscord, nt as normalizeDiscordSlug, oS as resolveAckReaction, oT as canonicalizeAllowlistWithResolvedIds, oa as formatMention, ob as fetchRemoteMedia, on as buildCommandTextFromArgs, ot as resolveDiscordMemberAccessState, pm as resolveConfiguredAcpRoute, ps as isRecentlyUnboundThreadWebhookMessage, pt as formatDiscordUserTag, qi as formatDiscordComponentEventText, qy as getAgentScopedMediaLocalRoots, rC as loadSessionStore, r_ as recordPendingHistoryEntryIfEnabled, rs as deleteMessageDiscord, rt as resolveDiscordAllowListMatch, s as isProfileInCooldown, s_ as matchesMentionWithExplicit, sg as createReplyPrefixOptions, sn as findCommandByNativeName, st as resolveDiscordOwnerAccess, tC as isDangerousNameMatchingEnabled, tS as createDiscordRetryRunner, ta as sendMessageDiscord, tn as hasControlCommand, ts as isThreadArchived, tt as normalizeDiscordAllowList, uT as summarizeMapping, ut as resolveGroupDmAllow, vn as parseCommandArgs, wE as ensureAuthProfileStore, wa as editChannelDiscord, x_ as getAcpSessionManager, y_ as resolveThreadBindingsEnabled, yn as resolveCommandArgChoices, zS as resolveExecApprovalCommandDisplay } from "./auth-profiles-Bc6TPi0n.js";
import { w as normalizeProviderId } from "./model-selection-DJOYg7Dx.js";
import "./agent-scope-B-OyGztR.js";
import { d as resolveThreadSessionKeys, u as resolveAgentIdFromSessionKey } from "./session-key-DyhRsRh-.js";
...
import { n as logError, t as logDebug } from "./logger-iZtdpoh6.js";
import "./exec-CwhzW0JB.js";
import "./workspace-Dns6NMt3.js";
import { on as resolveDiscordPreviewStreamMode, s as loadConfig } from "./io-CezuVcrG.js";
...
import { O as summarizeStringEntries, S as stripReasoningTagsFromText, b as resolveTextChunkLimit, c as convertMarkdownTables, r as chunkItems, t as withTimeout, y as resolveChunkMode } from "./text-runtime-Cv7IlZFR.js";
...
import { i as resolveAgentRoute, n as deriveLastRoutePolicy, t as buildAgentSessionKey } from "./resolve-route-CUHslQlg.js";
import "./internal-hooks-CWvLyTiW.js";
import { n as shouldAckReaction } from "./ack-reactions-DQfgs0j1.js";
import { f as warnMissingProviderGroupPolicyFallbackOnce, l as resolveDefaultGroupPolicy, o as GROUP_POLICY_BLOCKED_LABEL, u as resolveOpenProviderRuntimeGroupPolicy } from "./group-access-BWGTPTwF.js";
import { b as enqueueSystemEvent, k as formatDurationSeconds } from "./lazy-runtime-07jXxTa3.js";
...
import { s as isAcpRuntimeError } from "./registry-CeB-k--4.js";
...
import { t as resolveDiscordChannelAllowlist } from "./resolve-channels-6thX82Sf.js";
...
import { ApplicationCommandOptionType, ButtonStyle, ChannelType as ChannelType$1, Routes, StickerFormatType } from "discord-api-types/v10";
...
async function resolveDiscordPreflightAudioMentionContext(params) {
	...
	if (needsPreflightTranscription) {
		...
		try {
			const { transcribeFirstAudio } = await import("./preflight-audio.runtime-BWZtWImY.js");
			if (params.abortSignal?.aborted) return {
				hasAudioAttachment,
				hasTypedText
			};
...
async function loadDiscordVoiceRuntime() {
	discordVoiceRuntimePromise ??= import("./manager.runtime-BQqZu_hP.js");
