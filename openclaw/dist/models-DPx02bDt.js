...
import { S as resolveOpenClawAgentDir, b as resolveAuthStorePathForDisplay } from "./setup-binary-nB5GxsnS.js";
import { $a as DEFAULT_OAUTH_WARN_MS, Al as loadProviderUsageSummary, Am as createVpsAwareOAuthHandlers, Bm as resolveKnownAgentId, EE as loadAuthProfileStoreForRuntime, Eu as describeFailoverError, Fm as formatTokenK, Gm as applyAuthProfileConfig, Hm as resolveModelTarget, IE as resolveAuthProfileDisplayLabel, Im as isLocalBaseUrl, Lm as loadValidConfigOrThrow, Mm as applyDefaultModelPrimaryUpdate, Nl as formatUsageWindowSummary, Nm as ensureFlagCompatibility, Pm as formatMs, Pn as resolvePluginProviders, Qa as maskApiKey, Rm as mergePrimaryFallbackConfig, Sv as shouldSuppressBuiltInModel, Um as updateConfig, Vb as loadModelCatalog, Vm as resolveModelKeysFromEntries, Wm as upsertCanonicalModelConfigEntry, _v as resolveModelWithRegistry, ax as hasUsableCustomProviderApiKey, bE as setAuthProfileOrder, bv as discoverAuthStorage, bx as isNonSecretApiKeyMarker, cx as resolveAwsSdkEnvVarName, d as resolveProfileUnusableUntilForDisplay, dx as resolveUsableCustomProviderApiKey, eo as buildAuthHealthSummary, i as clearAuthProfileCooldown, lx as resolveEnvApiKey, n as resolveAuthProfileOrder, qc as runEmbeddedPiAgent, rx as getCustomProviderApiKey, sx as resolveApiKeyForProvider, t as resolveAuthProfileEligibility, to as formatRemainingShort, vE as listProfilesForProvider, wE as ensureAuthProfileStore, xE as upsertAuthProfile, xu as resolveCommandSecretRefsViaGateway, xv as discoverModels, zm as normalizeAlias } from "./auth-profiles-Bc6TPi0n.js";
import { C as findNormalizedProviderValue, O as DEFAULT_MODEL, _ as resolveModelRefFromString, c as modelKey, d as parseModelRef, h as resolveDefaultModelForAgent, k as DEFAULT_PROVIDER, m as resolveConfiguredModelRef, r as buildModelAliasIndex, w as normalizeProviderId } from "./model-selection-DJOYg7Dx.js";
import { S as toAgentModelListLike, a as resolveAgentDir, b as resolveAgentModelFallbackValues, m as resolveDefaultAgentId, p as resolveAgentWorkspaceDir, s as resolveAgentExplicitModelPrimary, u as resolveAgentModelFallbacksOverride, x as resolveAgentModelPrimaryValue } from "./agent-scope-B-OyGztR.js";
...
import { Dn as shouldEnableShellEnvFallback, f as readConfigFileSnapshotForWrite, i as createConfigIO, m as setRuntimeConfigSnapshot, s as loadConfig, wn as getShellEnvAppliedKeys } from "./io-CezuVcrG.js";
...
import { n as resolveSecretRefString } from "./resolve-D7R3Obgc.js";
import { t as formatCliCommand } from "./command-format-C8aJknFW.js";
import { a as resolveSessionTranscriptPath, c as resolveSessionTranscriptsDirForAgent } from "./paths-BumENdHQ.js";
import { n as logConfigUpdated } from "./logging-imcVaYUC.js";
import { i as stylePromptTitle, n as stylePromptHint, r as stylePromptMessage } from "./note-aKR6kEr4.js";
import { i as getModelsCommandSecretTargetIds } from "./command-secret-targets-Ow94fQb1.js";
import { m as resolveUsageProviderId } from "./provider-usage-La8jvEfN.js";
import { r as withProgressTotals } from "./progress-B4roBB_B.js";
import { d as openUrl } from "./onboard-helpers-vGwtm3SO.js";
import { n as renderTable, t as getTerminalTableWidth } from "./table-B8SbFA2P.js";
import { n as redactSecrets } from "./format-Bn_kkmHW.js";
import { t as createClackPrompter } from "./clack-prompter-CGqWkGcW.js";
import { t as isRemoteEnvironment } from "./oauth-env-Wbgjl7N2.js";
import { i as resolveProviderMatch, n as mergeConfigPatch, r as pickAuthMethod, t as applyDefaultModel } from "./provider-auth-choice-helpers-DMPZITJF.js";
import { t as buildProviderAuthRecoveryHint } from "./provider-auth-guidance-070edE4a.js";
import { t as inferParamBFromIdOrName } from "./model-param-b-BeG8ESQe.js";
...
async function modelsListCommand(opts, runtime) {
	ensureFlagCompatibility(opts);
	const { ensureAuthProfileStore } = await import("./auth-profiles.runtime-DOhSUV_k.js");
	const { ensureOpenClawModelsJson } = await import("./models-config-DdHoh-qY.js");
