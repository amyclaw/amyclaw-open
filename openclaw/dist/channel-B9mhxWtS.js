import { UT as deleteAccountFromConfigSection, WC as buildBaseAccountStatusSnapshot, WT as setAccountEnabledInConfigSection, gT as mapAllowFromEntries, kT as buildAccountScopedDmSecurityPolicy, tC as isDangerousNameMatchingEnabled } from "./auth-profiles-Bc6TPi0n.js";
...
import { n as buildChannelSendResult } from "./text-chunking-DjnX5OPU.js";
import { C as startZaloQrLogin, O as zalouserSetupAdapter, T as getZalouserRuntime, a as resolveDefaultZalouserAccountId, c as getZaloUserInfo, d as listZaloGroupMembers, i as listZalouserAccountIds, m as logoutZaloProfile, n as writeQrDataUrlToTempFile, o as resolveZalouserAccountSync, p as listZaloGroupsMatching, r as getZcaUserInfo, s as checkZaloAuthenticated, t as zalouserSetupWizard, u as listZaloFriendsMatching, w as waitForZaloQrLogin } from "./zalouser-DTlGr6mt.js";
...
import { a as sendReactionZalouser, d as buildZalouserGroupCandidates, f as findZalouserGroupEntry, i as sendMessageZalouser, u as resolveZalouserReactionMessageIds } from "./send-C8zjYaAk.js";
import { z } from "zod";
...
const zalouserPlugin = {
	...
	gateway: {
		startAccount: async (ctx) => {
			...
			const { monitorZalouserProvider } = await import("./monitor-kNmIcL8a.js");
