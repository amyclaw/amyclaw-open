import { l as testRegexWithBoundedInput, o as compileSafeRegex } from "./redact-fatrROh9.js";
import { i as formatUncaughtError, r as formatErrorMessage } from "./errors-DOJWZqNo.js";
import { a as registerUnhandledRejectionHandler } from "./unhandled-rejections-BT0Rsc03.js";
import { i as getChildLogger } from "./logger-ByBU4z1U.js";
import { _ as resolveStateDir } from "./paths-1qR_mW4i.js";
import { a as logVerbose, d as warn, l as shouldLogVerbose, t as danger } from "./globals-DqZvRoPX.js";
import { m as defaultRuntime, p as createNonExitingRuntime, t as createSubsystemLogger } from "./subsystem-MGyxt_Bl.js";
import { $f as buildInlineKeyboard, A_ as finalizeInboundContext, Af as resolveTelegramExecApprovalTarget, Ao as createTelegramThreadBindingManager, Ap as buildSenderName, As as dispatchReplyWithBufferedBlockDispatcher, Bb as findModelInCatalog, Bp as hasBotMention, Cp as wrapFileReferencesInHtml, Df as isTelegramExecApprovalApprover, Dp as splitTelegramCaption, Eb as formatReasoningMessage, Ef as getTelegramExecApprovalApprovers, Ep as shouldRetryTelegramIpv4Fallback, Es as recordInboundSession, FS as buildExecApprovalPendingReplyPayload, Fd as resolvePinnedMainDmOwnerFromAllowlist, Ff as buildProviderKeyboard, Fp as buildTypingThreadParams, Fs as formatInboundEnvelope, GT as firstDefined, Gp as resolveTelegramMediaPlaceholder, Gt as DEFAULT_EMOJIS, Hg as logAckFailure, Hp as resolveTelegramDirectPeerId, Hw as resolveCommandAuthorizedFromAuthorizers, If as calculateTotalPages, Ip as describeReplyTarget, Jp as resolveTelegramThreadSpec, Jt as createStatusReactionController, Jv as resolvePluginConversationBindingApproval, K as matchPluginCommand, KS as computeBackoff, Kf as getCachedSticker, Kp as resolveTelegramReplyId, Kv as parsePluginBindingApprovalCustomId, Kx as resolveTelegramAccount, Lf as getModelsPageSize, Lp as expandTextLinks, Lw as createFinalizableDraftLifecycle, Mf as shouldSuppressLocalTelegramExecApprovalPrompt, Mp as buildTelegramGroupPeerId, Ms as createInboundDebouncer, Nc as resolveChannelConfigWrites, Np as buildTelegramParentPeer, Ns as resolveInboundDebounceMs, Oc as isBtwRequestText, Of as isTelegramExecApprovalClientEnabled, Oh as issuePairingChallenge, Op as buildGroupLabel, PC as applyModelOverrideToSessionEntry, Pf as buildModelsKeyboard, Pp as buildTelegramThreadParams, Qg as buildPendingHistoryContextFromMap, Qp as resolveSenderAllowMatch, Qt as resolveNativeCommandSessionTargets, Rf as parseModelCallbackData, Rn as dispatchPluginInteractiveHandler, Rp as extractTelegramLocation, Rs as resolveEnvelopeFormatOptions, Rv as buildPluginBindingResolvedText, Sp as renderTelegramHtmlText, Tp as resolveTelegramTransport, U as executePluginCommand, Ub as modelSupportsVision, Uf as cacheSticker, Ug as logInboundDrop, Up as resolveTelegramForumThreadId, Us as buildModelsProviderData, Uw as resolveControlCommandGate, VC as resolveMarkdownTableMode, Vb as loadModelCatalog, Vp as normalizeForwardedContext, W as getPluginCommandSpecs, WS as createDedupeCache, Wf as describeStickerImage, Wg as logTypingFailure, Wl as buildCommandsMessagePaginated, Wp as resolveTelegramGroupAllowFromContext, Ws as formatModelsAvailableHeader, Wv as isPluginOwnedSessionBindingRecord, Wy as loadWebMedia, Xp as normalizeAllowFrom, Xt as recordInboundSessionMetaSafe, Yp as isSenderAllowed, Yy as buildOutboundMediaLoadOptions, Za as resolveStoredModelOverride, Zp as normalizeDmAllowFromWithStore, Zv as getSessionBindingService, __ as resolveThreadBindingMaxAgeMsForChannel, _n as normalizeCommandBody, _p as isTelegramClientRejection, _s as toLocationContext, a_ as buildMentionRegexes, ab as MediaFetchError, ag as createTypingCallbacks, aw as resolveChannelGroupPolicy, bn as resolveCommandArgMenu, bp as markdownToTelegramChunks, bs as resolveMentionGatingWithBypass, cp as sendMessageTelegram, dp as sendTypingTelegram, e_ as clearHistoryEntriesIfEnabled, en as shouldDebounceTextInbound, fm as ensureConfiguredAcpRouteReady, gm as resolveTelegramInlineButtonsScope, gp as isSafeToRetrySendError, gs as formatLocationText, h_ as resolveThreadBindingIdleTimeoutMsForChannel, hn as listNativeCommandSpecsForConfig, hp as isRecoverableTelegramNetworkError, iC as readSessionUpdatedAt, ip as editMessageTelegram, jf as shouldEnableTelegramExecApprovalButtons, jp as buildTelegramGroupFrom, kS as resolveExecApprovalSessionTarget, kf as resolveTelegramExecApprovalConfig, kp as buildSenderLabel, kv as getGlobalHookRunner, lC as updateSessionStore, lm as upsertChannelPairingRequest, mm as withTelegramApiErrorLogging, mn as listNativeCommandSpecs, mp as wasSentByBot, nc as listSkillCommandsForAgents, oC as resolveSessionStoreEntry, oS as resolveAckReaction, ob as fetchRemoteMedia, on as buildCommandTextFromArgs, ow as resolveChannelGroupRequireMention, pm as resolveConfiguredAcpRoute, pp as resolveTelegramVoiceSend, qS as sleepWithAbort, qp as resolveTelegramStreamMode, qs as buildCommandsPaginationKeyboard, qy as getAgentScopedMediaLocalRoots, rC as loadSessionStore, r_ as recordPendingHistoryEntryIfEnabled, rm as readChannelAllowFromStore, rp as editMessageReplyMarkupTelegram, s_ as matchesMentionWithExplicit, sg as createReplyPrefixOptions, sn as findCommandByNativeName, so as isAbortRequestText, tn as hasControlCommand, ty as resolveCommandAuthorization, v_ as resolveThreadBindingSpawnPolicy, vn as parseCommandArgs, vp as isTelegramPollingNetworkError, wp as resolveTelegramFetch, xp as markdownToTelegramHtml, yS as readJsonBodyWithLimit, yp as tagTelegramNetworkError, zS as resolveExecApprovalCommandDisplay, zf as resolveModelSelection, zp as getTelegramTextParts } from "./auth-profiles-Bc6TPi0n.js";
import { h as resolveDefaultModelForAgent } from "./model-selection-DJOYg7Dx.js";
import { a as resolveAgentDir, m as resolveDefaultAgentId } from "./agent-scope-B-OyGztR.js";
import { S as parseAgentSessionKey, d as resolveThreadSessionKeys, f as sanitizeAgentId, r as buildAgentMainSessionKey, u as resolveAgentIdFromSessionKey } from "./session-key-DyhRsRh-.js";
import { n as normalizeAccountId } from "./account-id-O4Og6DrK.js";
import { A as TELEGRAM_COMMAND_NAME_PATTERN, M as normalizeTelegramCommandName, N as resolveTelegramCustomCommands, Sn as resolveAgentMaxConcurrent, g as writeConfigFile, s as loadConfig } from "./io-CezuVcrG.js";
import { C as findCodeRegions, S as stripReasoningTagsFromText, b as resolveTextChunkLimit, g as chunkMarkdownTextWithMode, o as resolveGlobalSingleton, w as isInsideCode, y as resolveChunkMode } from "./text-runtime-Cv7IlZFR.js";
import { c as resolveNativeCommandsEnabled, l as resolveNativeSkillsEnabled, o as isNativeCommandsExplicitlyDisabled } from "./workspace-dirs-B6rDmzuU.js";
import { P as saveMediaBuffer } from "./routes-AlbnCYWi.js";
import { o as isGifMedia, s as kindFromMime } from "./mime-_IkgFMS2.js";
import { a as resolveInboundLastRouteSessionKey, i as resolveAgentRoute, n as deriveLastRoutePolicy, t as buildAgentSessionKey } from "./resolve-route-CUHslQlg.js";
import { d as triggerInternalHook, n as createInternalHookEvent } from "./internal-hooks-CWvLyTiW.js";
import { n as shouldAckReaction, t as removeAckReactionAfterReply } from "./ack-reactions-DQfgs0j1.js";
import { n as evaluateMatchedGroupAccessForPolicy, u as resolveOpenProviderRuntimeGroupPolicy } from "./group-access-BWGTPTwF.js";
import { O as formatDurationPrecise, b as enqueueSystemEvent } from "./lazy-runtime-07jXxTa3.js";
import { l as resolveStorePath } from "./paths-BumENdHQ.js";
import { y as recordChannelActivity } from "./send-TDX_qI_x.js";
...
import { Wt as retryAsync } from "./provider-models-Cym0TctV.js";
import { t as waitForAbortSignal } from "./abort-signal-CBBUAVA8.js";
import { _ as startDiagnosticHeartbeat, f as logWebhookError, m as logWebhookReceived, p as logWebhookProcessed, v as stopDiagnosticHeartbeat } from "./diagnostic-D8TBqX9f.js";
import { a as toInternalMessageSentContext, d as toPluginMessageSentEvent, f as fireAndForgetHook, l as toPluginMessageContext, t as buildCanonicalSentMessageHookContext } from "./message-hook-mappers-MHm61O7_.js";
import { t as createOperatorApprovalsGatewayClient } from "./gateway-runtime-50-32dyb.js";
import { n as readTelegramUpdateOffset, r as writeTelegramUpdateOffset } from "./update-offset-store-Cpcejbrf.js";
...
async function resolveTelegramInboundBody(params) {
	...
	if (isGroup && requireMention && hasAudio && !hasUserText && mentionRegexes.length > 0 && !disableAudioPreflight) try {
		const { transcribeFirstAudio } = await import("./media-understanding.runtime-BFx0gg_n.js");
...
//#endregion
export { monitorTelegramProvider as n, buildTelegramExecApprovalButtons as r, probeTelegram as t };
