...
declare const listIrcAccountIds: (cfg: import("openclaw/plugin-sdk/irc").OpenClawConfig) => string[], resolveDefaultIrcAccountId: (cfg: import("openclaw/plugin-sdk/irc").OpenClawConfig) => string;
